...
namespace ShopNum1.ShopWebControl
{
    ...
    public class ProductListSaleRanking : BaseWebControl
    {
        ...
        private string skinFilename = "ProductListSaleRanking.ascx";
        ...
        protected void BindData()
        {
            ...
            DataTable saleRankingProduct = action.GetSaleRankingProduct(s, MemLoginID,CookieCustomerCategory);
            RepeaterData.DataSource = saleRankingProduct;
