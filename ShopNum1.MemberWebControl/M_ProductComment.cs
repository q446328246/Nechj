...
namespace ShopNum1.MemberWebControl
{
    ...
    public class M_ProductComment : BaseMemberWebControl
    {
        ...
        private HtmlInputHidden hidListAttitude;
        private HtmlInputHidden hidListCharacter;
        private HtmlInputHidden hidListSpeed;
        private HtmlInputHidden hidNick;
        private HtmlInputHidden hidPGuId;
        private HtmlInputHidden hidProductName;
        private HtmlInputHidden hidProductPrice;
        private HtmlInputHidden hidShopId;
        private HtmlInputHidden hidSpecValue;
        private string skinFilename = "M_ProductComment.ascx";
        ...
        {
            hidNick = (HtmlInputHidden) skin.FindControl("hidNick");
            hidSpecValue = (HtmlInputHidden) skin.FindControl("hidSpecValue");
            hidProductName = (HtmlInputHidden) skin.FindControl("hidProductName");
            ...
            hidListCharacter = (HtmlInputHidden) skin.FindControl("hidListCharacter");
            hidListSpeed = (HtmlInputHidden) skin.FindControl("hidListSpeed");
            hidListAttitude = (HtmlInputHidden) skin.FindControl("hidListAttitude");
            hidProductPrice = (HtmlInputHidden) skin.FindControl("hidProductPrice");
