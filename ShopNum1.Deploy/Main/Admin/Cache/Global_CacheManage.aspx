<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Global_CacheManage.aspx.cs" Inherits="ShopNum1.Deploy.Main.Admin.Cache.Global_CacheManage" %>
        ...
        <script type="text/javascript">
            ...
            function getcachename() {
                ...
                case '13':
                    ...
                    break;
                case '14':
                    cachename = '更新店铺前台Meto缓存';
                    break;
                case '15':
                    cachename = '更新平台前台Meto缓存';
                    break;
                case '16':
                    cachename = '更新在线会员缓存';
                    break;
    ...
    <body>
        <div class="ManagerForm">
            <form id="Form1" method="post" runat="server">
                <div id="success" style="height: 120px; left: 50%; margin-left: -150px; margin-top: -80px; position: absolute; top: 50%; width: 284px; z-index: 300;">
                    <div id="Layer2" style="background-color: #FFFFFF; border: solid #ddd 1px; font-size: 14px; height: 90px; position: absolute; width: 270px; z-index: 300;">
                        <div id="Layer4" style="background: #f1f1f1; font-weight: bolder; height: 26px; line-height: 26px; padding: 0px 3px 0px 3px;">
                            操作提示</div>
                    ...
                    <div id="Layer3" style="background-color: #E8E8E8; height: 90px; left: 4px; position: absolute; top: 5px; width: 270px; z-index: 299;">
                    </div>
                </div>
