<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdvanceSettlementApplyLog.aspx.cs" Inherits="ShopNum1.Deploy.Main.Admin.AdvanceSettlementApplyLog" %>
...
<body class="widthah">
    ...
    <div id="right">
            ...
            <div class="order_edit">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td class="lmf_padding">
                            <asp:Label ID="LabelSMemRealName" runat="server" Text="用户姓名："></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBoxSRealName" runat="server" CssClass="tinput" Width="150px"></asp:TextBox>
                        </td>
                        <td class="lmf_padding">
                            <asp:Label ID="LabelSOperateStatus" runat="server" Text="结算状态："></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="DropdownListSOperateStatus" runat="server" Width="100px" CssClass="tselect">
                                ...
                                <asp:ListItem Value="2">确认状态</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td class="lmf_padding">
                    ...
                    <tr height="30" style="display: none;">
                        ...
                        <td>
                            <asp:DropDownList ID="DropdownListSOperateType" runat="server" Width="180px" CssClass="tselect">
                                <asp:ListItem Value="0" Selected="True">结算</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td colspan="2">
                        </td>
                        ...
                        <tr>
                            <td valign="top" style="display: none;">
                                <asp:LinkButton ID="ButtonDelete" runat="server" OnClick="ButtonDelete_Click" OnClientClick=" if (Page_ClientValidate()) return DeleteButton();return false; "
                                    CausesValidation="False"  Visible="false" class="shanchu lmf_btn"><span>批量删除</span></asp:LinkButton>
                            </td>
                            ...
                            <%--<td valign="top" class="lmf_app">
                                    <span><asp:Button ID="ButtonProportion" runat="server" Text="结算" OnClientClick=" return OperateButton() "
                                CssClass="dele" onclick="ButtonProportion_Click"  /></span>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <input id="checkboxItem" value='<%# Eval("rowId") %>' type="checkbox" />
                        </ItemTemplate><ItemStyle HorizontalAlign="Center" Width="30px" />
                    </asp:TemplateField>
                    <asp:BoundField DataField="MemLoginId" HeaderText="MemLoginId" Visible="False" />
                    ...
                    <asp:BoundField DataField="CreateTime" HeaderText="结算日期" SortExpression="CreateTime">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Bonus1" HeaderText=" 静态收益" SortExpression="Bonus1">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Bonus2" HeaderText="推荐收益" SortExpression="Bonus2">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Bonus4" HeaderText="节点收益" SortExpression="Bonus4">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Bonus5" HeaderText="签到收益" SortExpression="Bonus5">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    ...
                    <%--<asp:TemplateField HeaderText="操作" SortExpression="IsShow">
                        <ItemTemplate>
                            <a href="<%# "AdvanceSettlementApplyLog_Operate.aspx?MemLoginNO=" + Eval("MemLoginNO") + "&Times="+Eval("CreateTime")+"" %>"
                                style="color: #4482b4;">查看</a>
                            <asp:LinkButton ID="LinkDelte" runat="server" Style="color: #4482b4;" CommandArgument='<%# Eval("MemLoginNO") %>'
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="SearchJs_QLX"
