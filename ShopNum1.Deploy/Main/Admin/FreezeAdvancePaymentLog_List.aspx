<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FreezeAdvancePaymentLog_List.aspx.cs"
    Inherits="ShopNum1.Deploy.Main.Admin.FreezeAdvancePaymentLog_List" %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="冻结|解冻金额" SortExpression="OperateMoney">
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# ChangeOperateType(DataBinder.Eval(Container, "DataItem(OperateType)", "{0}")) + "_" + Eval("OperateMoney") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
            ...
            <div id="divPage" runat="server" style="display: none;">
                <div class="navigator">
                    &nbsp;
                    <asp:Label ID="LabelPageTitle" runat="server" Font-Bold="True" Text="冻结解冻金币（BV）"></asp:Label>
                </div>
