...
{
    public partial class CategoryAdBuyAudit_List : PageBase, IRequiresSessionState
    {
        ...
        {
            base.Response.Redirect("CategoryAdBuy_SearchDetail.aspx?guid=" + CheckGuid.Value + "&&type=Audit");
        }
