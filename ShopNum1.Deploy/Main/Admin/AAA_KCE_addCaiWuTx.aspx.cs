...
{
    public partial class AAA_KCE_addCaiWuTx : PageBase, IRequiresSessionState
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string p = Post("http://api.ikex8.com/api.php?api_key=WGHaN3trZHGkUF7x&action=get_main_account_balance");
            Label1.Text = p;
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string p = Post("http://api.ikex8.com/api.php?api_key=WGHaN3trZHGkUF7x&action=with_draw&amount=" + Tx);
                if (p !="")
                {
