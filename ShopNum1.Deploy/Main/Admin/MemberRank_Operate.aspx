<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="MemberRank_Operate.aspx.cs"
    Inherits="ShopNum1.Deploy.Main.Admin.MemberRank_Operate" %>
    ...
    <script type="text/javascript">
        ...
        function openLogoSingleChild() {
            ...
            if (k != null) {
                ...
                document.getElementById("ImageOriginalImge").src = "/ImgUpload/" + k.substring(lastIndex + 1, strLen);
            }
        }
    </script>
</head>
        ...
        <div class="welcon clearfix">
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelMinScore" runat="server" Text="最小红包满足点："></asp:Label>
                        </th>
                        <td>
                            <asp:TextBox ID="TextBoxMinScore" MaxLength="9" CssClass="tinput" ReadOnly="true"
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelMaxScore" runat="server" Text="最大红包满足点："></asp:Label>
                        </th>
                        <td>
                            ...
                            <asp:CompareValidator ID="CompareDataTime" runat="server" ControlToValidate="TextBoxMinScore"
                                Display="Dynamic" ErrorMessage="最大红包满足点不能小于最小红包满足点" Operator="LessThan" Type="Double"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img runat="server" src="/ImgUpload/2011090809095523x.png" id="ImageOriginalImge"
