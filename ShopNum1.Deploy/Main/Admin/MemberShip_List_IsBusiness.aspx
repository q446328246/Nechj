<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberShip_List_IsBusiness.aspx.cs" Inherits="ShopNum1.Deploy.Main.Admin.MemberShip_List_IsBusiness" %>
            ...
            <div class="mhead">
                <div class="ml">
                    <div class="mr">
                        <ul class="mul">
                            <li id="current1">
                                <asp:LinkButton ID="LinkButtonAll1" runat="server" CssClass="cur" OnClick="LinkButtonAll_Click1">申请列表</asp:LinkButton>
                            </li>
                            <li id="current2">
                            <asp:LinkButton ID="LinkButtonPayment1" runat="server" OnClick="LinkButtonPayment_Click1">已审核商家</asp:LinkButton>
                           ...
                           <%-- <li id="current3">
                            ...
                            <li id="current5">
                                <asp:LinkButton ID="LinkButtonDeleted1" runat="server" OnClick="LinkButtonDeleted_Click1">已拒绝商家</asp:LinkButton>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="welcon clearfix">
            ...
            <cc1:Num1GridView ID="ShipNum1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="身份证" DataField="CardID" SortExpression="CardID">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField HeaderText="商家名称" DataField="ShopName" SortExpression="ShopName">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="详细" SortExpression="IsShow1">
                        <ItemTemplate>
                            <a href="MeberShip_Particular_IsBusiness.aspx?MembershipID=<%#Eval("ID")%>" style="color: #4482b4;">
                                查看</a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="15%" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="操作" SortExpression="IsShow3">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkPass" runat="server" Style="color: #4482b4;" CommandArgument='<%# Eval("ID") %>'
...
<%--                   <asp:TemplateField HeaderText="操作" SortExpression="IsShow2">
                        <ItemTemplate>
                            <a href="MemberShip_Edit.aspx?MembershipID=<%#Eval("ID")%>" style="color: #4482b4;">
                                操作</a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="15%" />
                    </asp:TemplateField>--%>
        ...
        <asp:ObjectDataSource ID="ShipObjectDataSourceDate" runat="server" SelectMethod="SearchShipNEC"
            TypeName="ShopNum1.BusinessLogic.ShopNum1_MemberShip_Action">
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="0" Name="Shipstatu" QueryStringField="ShipState"
                    Type="Int32" />
            </SelectParameters>
