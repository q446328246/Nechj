        ...
        contents: [{
                ...
                elements: [{ id: 'linkType', type: 'select', label: E.type, 'default': 'url', items: [[E.toUrl, 'url'], [E.toAnchor, 'anchor'], [E.toEmail, 'email']], onChange: d, setup: function(F) { if (F.type) this.setValue(F.type); }, commit: function(F) { F.type = this.getValue(); } }, {
                                ...
                                children: [{
                                    ...
                                    children: [{
                                            ...
                                            setup: function(F) {
                                                ...
                                                I.clear();
                                                I.add('');
                                                for (var G = 0; G < F.anchors.length;
                                                    G++) {
                        ...
                        children: [{
                                ...
                                setup: function(F) { if (F.email) this.setValue(F.email.subject); },
                                commit: function(F) {
                                    if (!F.email) F.email = {};
                                ...
                                rows: 3,
                                'default': '',
                                setup: function(F) { if (F.email) this.setValue(F.email.body); },
                                commit: function(F) {
                                    if (!F.email) F.email = {};
                ...
                elements: [{
                    ...
                    children: [{
                            ...
                            'default': '',
                            setup: function(F) { if (F.target) this.setValue(F.target.name); },
                            commit: function(F) {
                                if (!F.target) F.target = {};
