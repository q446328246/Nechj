...
{
    public partial class ArticleComment_List : PageBase, IRequiresSessionState
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Page.Request.QueryString["ArticleGuid"] != null)
                {
                    LabelPageTitle.Text = "相关资讯评论";
                    HiddenFieldArticle.Value = Page.Request.QueryString["ArticleGuid"];
                }
                BindGrid();
                BindStatus();
            }
