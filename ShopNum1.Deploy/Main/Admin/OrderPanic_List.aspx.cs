...
{
    public partial class OrderPanic_List : PageBase, IRequiresSessionState
    {
        ...
        protected void BindGrid(string strcondition)
        {
            ...
            DataTable dataTable = shopNum1_OrderInfo_Action.SelectList(this.int_0.ToString(), this.string_4, strcondition, "0", "OrderNumber", "desc");
            ...
            this.dt_OrderList = shopNum1_OrderInfo_Action.SelectList(this.int_0.ToString(), this.string_4, strcondition, "1", "OrderNumber", "desc");
