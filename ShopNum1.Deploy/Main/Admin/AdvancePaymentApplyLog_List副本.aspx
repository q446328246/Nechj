<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdvancePaymentApplyLog_List副本.aspx.cs"
...
<body class="widthah">
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
                        ...
                        <tr>
                            <td valign="top" >
                                <asp:LinkButton ID="ButtonDelete" runat="server" OnClick="ButtonDelete_Click" OnClientClick=" if (Page_ClientValidate()) return DeleteButton();return false; "
                                    CausesValidation="False" class="shanchu lmf_btn"><span>批量审批</span></asp:LinkButton>
                            </td>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="OperateMoney" HeaderText="提现金额" 
                        SortExpression="OperateMoney">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="ActualMoney" HeaderText="实际到账金额" SortExpression="ActualMoneys">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Bank" HeaderText="开户银行" SortExpression="Bank">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Account" HeaderText="开户卡号" SortExpression="Account">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="TrueName" HeaderText="开户名" SortExpression="TrueName">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    ...
                    <asp:TemplateField HeaderText="操作" SortExpression="IsShow">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="ButtonExamineBylink" runat="server" Style="color: #4482b4;" CommandArgument='<%# Eval("Guid") %>'
                                 OnClientClick=" return window.confirm('您确定要操作吗?'); " OnClick="ButtonExamineBylink_Click"
                                >审核</asp:LinkButton>
                            <%--<a href="<%# "AdvancePaymentMemApplyLog_Operate.aspx?guid=" + Eval("Guid") + "&Type=0" %>"
                                style="color: #4482b4;">拒绝</a>--%>
                            <asp:LinkButton ID="ButtonRefuseBylink" runat="server" Style="color: #4482b4;" CommandArgument='<%# Eval("Guid") %>'
                                OnClientClick=" return window.confirm('您确定要操作吗?'); " OnClick="ButtonRefuseBylink_Click">拒绝</asp:LinkButton>
                        </ItemTemplate>
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="SearchTx"
