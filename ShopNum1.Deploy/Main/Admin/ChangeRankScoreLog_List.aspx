<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="ChangeRankScoreLog_List.aspx.cs"
    Inherits="ShopNum1.Deploy.Main.Admin.ChangeRankScoreLog_List" %>
                ...
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr style="height: 35px; vertical-align: top;">
                            ...
                            <td>
                                <asp:TextBox ID="TextMemLoginIDValue" runat="server" CssClass="tinput" Width="150"></asp:TextBox>
                            </td>

                            <td>
                                <asp:Label ID="Label2" runat="server" Text="兑换积分："></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="Money" runat="server" CssClass="tinput" Width="150"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="Label4" runat="server" Text="备注："></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="beizhu" runat="server" CssClass="tinput" Width="150"></asp:TextBox>
                            </td>
                            <td>
                            <asp:Button ID="Button1" runat="server" CausesValidation="False" Text="确认添加"  
                                    CssClass="dele" onclick="Button1_Click" />
                            </td>
