<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="OrderPanic_List.aspx.cs"
    Inherits="ShopNum1.Deploy.Main.Admin.OrderPanic_List" %>
                ...
                <tbody>
                    ...
                    <tr style="cursor: default;" onmouseout="Num1GridViewShow_mout(this)" onmouseover="Num1GridViewShow_mover(this)">
                        ...
                        <td align="center" style="">
                            ...
                            <a style="color: #4482b4;" href="?orid=<%=dr["ordernumber"] %>&jk" onclick="return window.confirm('您确定要删除吗?');">
                                删除</a>
                        </td>
                    </tr>
                    <%}
