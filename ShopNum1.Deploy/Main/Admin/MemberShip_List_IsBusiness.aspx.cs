...
namespace ShopNum1.Deploy.Main.Admin
{
    ...
    public partial class MemberShip_List_IsBusiness : PageBase, IRequiresSessionState
    {
        ...
        {
            if (this.Page.Request.QueryString["Status"] != null)
            {
                this.ShipObjectDataSourceDate.SelectParameters["Shipstatu"].DefaultValue = this.Page.Request.QueryString["Status"].ToString();
            }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string text = (this.Page.Request.QueryString["Status"] == null) ? "0" : this.Page.Request.QueryString["Status"].ToString();
            switch (text)
            {
                case "0":
                    this.method_6(this.LinkButtonAll1);

                    break;
                case "1":
                    this.method_6(this.LinkButtonPayment1);
                    this.ShipNum1GridViewShow.Columns[6].Visible = false;
                ...
                //    break;
                case "2":
                    this.method_6(this.LinkButtonDeleted1);
                    this.ShipNum1GridViewShow.Columns[6].Visible = false;
        ...
        {
            this.LinkButtonAll1.CssClass = "";
            //this.LinkButtonNopayment.CssClass = "";can
            this.LinkButtonPayment1.CssClass = "";
        ...
        protected void ButtonDelete_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < id.Length; i++)
            {
                ...
                int num = action.DeleteNEC(id[i].ToString());
                ...
                else if (num > 0)
                {
                    var operateLog = new ShopNum1_OperateLog
                    {
                        ...
                        PageName = "MemberShip_List_IsBusiness.aspx",
        ...
        protected void LinkButtonAll_Click1(object sender, EventArgs e)
        {
            string id = "0";
            base.Response.Redirect("MemberShip_List_IsBusiness.aspx?Status=" + id);
        }
        ...
        protected void LinkButtonPayment_Click1(object sender, EventArgs e)
        {
            string id = "1";
            base.Response.Redirect("MemberShip_List_IsBusiness.aspx?Status=" + id);
        }
        ...
        protected void LinkButtonDeleted_Click1(object sender, EventArgs e)
        {
            string id = "2";
            base.Response.Redirect("MemberShip_List_IsBusiness.aspx?Status=" + id);
        }
        ...
        {
            string text = (this.Page.Request.QueryString["Status"] == null) ? "1" : this.Page.Request.QueryString["Status"].ToString();
            ...
            else
            {
                ...
                DataTable SearchShip = action.SearchShipMemLoginNONEC(txtMemLoginID.Value, shipStaue);
