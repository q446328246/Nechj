<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdvancePaymentApplyLog_List.aspx.cs"
    Inherits="ShopNum1.Deploy.Main.Admin.AdvancePaymentApplyLog_List" %>
...
<body class="widthah">
    <form id="form1" runat="server">
        <div id="right">
            ...
            <div class="welcon clearfix">
                ...
                <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="OrderID" HeaderText="提现单号" SortExpression="OrderID">
                        ...
                        <asp:BoundField DataField="TxTime" HeaderText="时间" SortExpression="TxTime">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>

                        <asp:BoundField DataField="ETH" HeaderText="提现ETH"
                            SortExpression="ETH">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>

                        <asp:BoundField DataField="ETHAddress" HeaderText="提现地址" SortExpression="ETHAddress">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Shop_ETHAddress" HeaderText="NEC地址" SortExpression="Shop_ETHAddress">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="查询以太坊交易号" SortExpression="TxHash">
                            <ItemTemplate>
                                <%--<asp:LinkButton ID="selectJYstatus" Style="color: #4482b4;" CommandArgument='<%# Eval("TxHash") %>' OnClick="selectJYstatus_Click" runat="server">查询交易状态</asp:LinkButton>--%><asp:HyperLink Id="HyperLink1" NavigateUrl='<%# Eval("TxHash", "https://etherscan.io/tx/{0}") %>' Target="_blank" runat="server" style="color:#4482b4;">查询交易状态</asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="操作" SortExpression="IsShow">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="ButtonExamineBylink" runat="server" Style="color: #4482b4;" CommandArgument='<%# Eval("OrderID") %>'
                                    OnClientClick=" return window.confirm('您确定要审核操作吗?'); " OnClick="ButtonExamineBylink_Click">审核</asp:LinkButton>
                                <%--<a href="<%# "AdvancePaymentMemApplyLog_Operate.aspx?guid=" + Eval("Guid") + "&Type=0" %>"
                                style="color: #4482b4;">拒绝</a>--%>
                                <asp:LinkButton ID="ButtonRefuseBylink" runat="server" Style="color: #4482b4;" CommandArgument='<%# Eval("OrderID") %>'
            ...
            <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="ETHSearchTx"
