...
{
    public partial class CategoryAdBuy_List : PageBase, IRequiresSessionState
    {
        ...
        {
            base.Response.Redirect("CategoryAdBuy_SearchDetail.aspx?guid=" + CheckGuid.Value + "&&type=List");
        }
        ...
        protected void DropDownListAdPageName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (DropDownListAdPageName.SelectedValue != "-1")
            {
                ...
                if (DropDownListAdPageName.SelectedValue == "1")
                {
                    method_6("0", DropDownListCategory1);
                }
        ...
        protected void DropDownListCategory1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                method_6(DropDownListCategory1.SelectedValue.Split(new[] {'/'})[1], DropDownListCategory2);
            }
            else
            {
                DataTable table =
        ...
        protected void DropDownListCategory2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                method_6(DropDownListCategory2.SelectedValue.Split(new[] {'/'})[1], DropDownListCategory3);
            }
            else
            {
                DataTable table =
        ...
        private void BindData()
        {
            try
            {
                ((ShopNum1_CategoryAdPayMent_Action) LogicFactory.CreateShopNum1_CategoryAdPayMent_Action())
                    .UpdateIsEffective(DateTime.Now.ToString());
            }
            catch
            {
            }
