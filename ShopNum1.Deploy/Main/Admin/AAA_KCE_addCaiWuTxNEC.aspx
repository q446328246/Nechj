<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AAA_KCE_addCaiWuTxNEC.aspx.cs" Inherits="ShopNum1.Deploy.Main.Admin.AAA_KCE_addCaiWuTxNEC" %>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelTitle" runat="server" Text="财务提现NEC"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
