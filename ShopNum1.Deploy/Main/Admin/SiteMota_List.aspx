            ...
            <div class="order_edit">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr style="height: 35px; vertical-align: top;">
                        <td>
                            <asp:Label ID="LabelPageName" runat="server" Text="页面名："></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBoxPageName" runat="server" CssClass="orinput" Width="258"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Button ID="butSearch" runat="server" Text="查询" OnClick="butSearch_Click" class="dele" />
                        </td>
                    </tr>
                </table>
                <div class="sbtn">
                        ...
                        <tr>
                            ...
                            <td valign="top" class="lmf_app">
                                ...
                                <asp:LinkButton ID="ButtonDelete" CausesValidation="False" runat="server" OnClick="ButtonDelete_Click"
                                    OnClientClick=" return DeleteButton() " class="shanchu lmf_btn"><span>批量删除</span></asp:LinkButton>
                            </td>
                        </tr>
                    </table>
                </div>
