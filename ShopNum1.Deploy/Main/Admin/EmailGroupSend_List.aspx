<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="EmailGroupSend_List.aspx.cs"
    Inherits="ShopNum1.Deploy.Main.Admin.EmailGroupSend_List" %>
        ...
        <div class="welcon clearfix">
                        ...
                        <tr style="height: 35px; vertical-align: top;">
                            ...
                            <td colspan="3">
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TextBoxCreateTime1" runat="server" CssClass="tinput_data"></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxCreateTime2" runat="server" CssClass="tinput_data"></asp:TextBox>
                                        </td>
                                        <td style="padding-left: 4px; vertical-align: top;">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <%--<asp:TemplateField HeaderText="发送内容" SortExpression="State">
                        <ItemTemplate>
                            <%#Eval("SendObjectEmail")%>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>--%>
