<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="ShopSales.aspx.cs" Inherits="ShopNum1.Deploy.Main.Admin.ShopSales" %>
...
<body>
    ...
    <div id="right">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="SearchShopSalesClickCount"
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="txtshophost" Name="shophost" PropertyName="Text"
                    Type="String" DefaultValue="-1" />
                <asp:ControlParameter ControlID="txtshopname" Name="shopname" PropertyName="Text"
                    Type="String" DefaultValue="-1" />
