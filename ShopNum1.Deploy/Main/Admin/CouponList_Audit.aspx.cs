...
{
    public partial class CouponList_Audit : PageBase, IRequiresSessionState
    {
                ...
                var operateLog = new ShopNum1_OperateLog
                    {
                        ...
                        PageName = "CouponList_Audit.aspx",
        ...
        {
            base.Response.Redirect("CouponList_Search.aspx?guid=" + CheckGuid.Value + "&Type=Audit");
        }
