<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AAA_KCE_AdvancePaymentApplyLog_ListNEC.aspx.cs" Inherits="ShopNum1.Deploy.Main.Admin.AAA_KCE_AdvancePaymentApplyLog_ListNEC" %>
...
<body class="widthah">
    <form id="form1" runat="server">
        <div id="right">
            ...
            <div class="welcon clearfix">
                ...
                <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NEC" HeaderText="提现NEC"
                            SortExpression="NEC">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
            ...
            <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="NECSearchTx"
