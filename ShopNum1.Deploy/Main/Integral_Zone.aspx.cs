...
{
    public partial class Integral_Zone : PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HttpCookie cookie = new HttpCookie("category", Convert.ToInt32(CustomerCategory.积分专区).ToString());
            ...
            Response.Redirect(string.Format("http://shop100000027.{0}{1}", ShopSettings.siteDiscuzCookieDomain,"?category=3"), true);
        }
    }
}