<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="B_Head.ascx.cs" Inherits="ShopNum1.Deploy.Main.Bourse.Skin.B_Head" %>
...
<div id="nav_bg">
    <div id="nav">
        ...
        <ul style="float: left;">
            ...
            <li><a href="/main/Bourse/B_Index.aspx" class="zh">原料中心</a></li>
        </ul>
    </div>
</div>
<div style="clear: both;">
