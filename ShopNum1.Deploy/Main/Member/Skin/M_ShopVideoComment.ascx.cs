...
{
    public partial class M_ShopVideoComment : BaseMemberControl
    {
        ...
        public static string GetVideo(string guid)
        {
            ...
            DataTable titleByGuid =
                ((Shop_VideoComment_Action) LogicFactory.CreateShop_VideoComment_Action()).GetTitleByGuid(guid);
        ...
        {
            var action = (Shop_VideoComment_Action) LogicFactory.CreateShop_VideoComment_Action();
            string str = string.Empty;
