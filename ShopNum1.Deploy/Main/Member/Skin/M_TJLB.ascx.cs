...
{
    public partial class M_TJLB : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (type == "0")
            {
                ...
                DataTable table=memaction.TJLBGZYONG(MemberLoginID);
        ...
        protected void BindData()
        {
            ...
            str = str + "   AND  Superior='" + MemberLoginID + "'";
            ...
            DataTable table = action.Select_TJLB_List(commonModel);
            ...
            pageDiv.InnerHtml = new PageListBll("main/member/M_TJLB.aspx", true).GetPageListNew(pl);
            commonModel.Resultnum = "1";
            DataTable table2 = null;
            table2 = action.Select_TJLB_List(commonModel);
