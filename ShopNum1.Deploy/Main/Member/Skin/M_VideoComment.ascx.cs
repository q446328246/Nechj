...
{
    public partial class M_VideoComment : BaseMemberControl
    {
        ...
        public static string GetVideo(string guid)
        {
            ...
            DataTable titleByGuid =
                ((ShopNum1_Vedio_List_Action) LogicFactory.CreateShopNum1_Vedio_List_Action()).GetTitleByGuid(guid);
        ...
        {
            var action = (ShopNum1_VedioCommentChecked_Action) LogicFactory.CreateShopNum1_VedioCommentChecked_Action();
            string str = string.Empty;
