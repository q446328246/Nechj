...
{
    public partial class M_TJmemberTGYWY1 : BaseMemberControl
    {
        public string MemID;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HyperLink3.NavigateUrl = "http://" + ShopSettings.siteDomain + "/M_TJmemberTX.aspx?recommendid=" + MemID;
            ...
            HyperLink3.Text = "注册：http://" + ShopSettings.siteDomain + "/Main/MemberRegister.aspx?recommendid=" + MemID + "";
