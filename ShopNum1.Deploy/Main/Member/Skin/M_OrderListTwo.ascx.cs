...
{
    public partial class M_OrderListTwo : BaseMemberControl
    {
        ...
        public static DataTable dt_GetOrderProduct(string OrderGuId)
        {
            ...
            if (cookie2 != null)
            {
                return action.SelectOrderProductByGuIdorAllAndBuyerIdTwo(cookie2.Values["MemLoginID"], OrderGuId, HttpUtility.HtmlDecode(Common.Common.ReqStr("pn")));
            }
            else
            {
                return action.SelectOrderProductByGuIdorAllAndBuyerIdTwo("", OrderGuId, HttpUtility.HtmlDecode(Common.Common.ReqStr("pn")));
            }
        ...
        protected void BindData()
        {
            ...
            {
                ((ShopNum1_OrderInfo_Action)LogicFactory.CreateShopNum1_OrderInfo_Action()).DeleteOrderInfoByOrdernumtwo(
            ...
            if ((ordernumber != ""))
            {
                try
                {
                    DataTable dt = action.SelectOrdernumberTwo(ordernumber);
        ...
        protected void method_2()
        {
            ...
            int num3 =
                Convert.ToInt32(
                    action.SelectOrderListTwo(PageSize.ToString(), num.ToString(), method_1(), "3",
                        HttpUtility.HtmlDecode(Common.Common.ReqStr("pn"))).Rows[0][0]);
            var bll = new PageListBll("main/member/M_OrderListTwo.aspx", true);
            ...
            dt_OrderList = action.SelectOrderListTwo(PageSize.ToString(), num.ToString(), method_1(), "2",
