<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="M_ShopNewsComment.ascx.cs" Inherits="ShopNum1.Deploy.Main.Member.Skin.M_ShopNewsComment" %>
...
<div class="pad">
    <table border="0" cellspacing="0" cellpadding="0" class="lineh">
        <tr class="up_spac">
            ...
            <td>
                <asp:Button ID="ButtonGet" name="12" runat="server" Text="搜索" 
                    CssClass="chax btn_spc" onclick="ButtonGet_Click" />
            </td>
        </tr>
    </table>
</div>
