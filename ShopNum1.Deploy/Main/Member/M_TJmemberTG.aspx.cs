...
{
    public partial class M_TJmemberTG : PageBase
    {
        public string TEXT;
        public string URL;
        public void BindtITLE()
        {
            ...
            TEXT = "注册顾客：http://" + ShopSettings.siteDomain + "/MemberRegisterMandarin.aspx?recommendid=" + MemID;
            URL="http://" + ShopSettings.siteDomain + "/MemberRegisterMandarin.aspx?recommendid=" + MemID;
