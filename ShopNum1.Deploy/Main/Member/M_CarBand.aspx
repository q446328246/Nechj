...
<%@ Register Src="Skin/M_CarBand.ascx" TagName="M_CarBand"
    TagPrefix="uc1" %>
...
<body>
    ...
    <div class="dpsc_mian">
        <p class="ptitle">
            <a href="M_Welcome.aspx">车辆绑定</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">车辆绑定</span></p>
        <uc1:M_CarBand ID="M_CarBand" runat="server" PageSize="10" />
