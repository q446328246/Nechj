...
{
    public partial class MemberRegisterMandarin : System.Web.UI.UserControl
    {
        ...
        private void BindData()
        {
            ...
            TextBoxMemLoginID.Text = action.GetMemberNumberRegister();
        }
    ...
    //         }
            ...
            else
            {
                ...
                if (memberAction.CheckIdentityCard(txtIdentityCard.Text.Trim()) > 0)
                {
