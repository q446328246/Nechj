...
<div class="login_mod">
    <div class="NavTab clearfix">
        <a class="cur" href="javascript:;">登录</a> <a href="javascript:;">注册</a>
    </div>
    <div class="content">
        <!--登录-->
        <div>
            <div class="LoginBox1 clearfix">
                ...
                <dl>
                    <dt>密码：</dt>
                    <dd>
                        <asp:TextBox ID="TextBoxPwd" runat="server" CssClass="logtxt" TextMode="Password"
                            onblur="CheckIsEmalOrMobile()" onkeydown="if(event.keyCode==13){(document.getElementById('<%=ButtonLogin.CilentID %>')).focus();(document.getElementById('<%=ButtonLogin.CilentID %>')).click(); }"></asp:TextBox>
                        <br />
                        <span id="spanPwd" class="null"></span>
                    </dd>
                    <dd>
                        <a href="FindBackPassword.aspx" class="forget">忘记密码?</a></dd>
                </dl>
        ...
        <div class="hidden">
            <div class="LoginBox1 clearfix PopRegisterBox">
                ...
                <dl>
                    <dt>邮箱：</dt>
                    <dd>
                        <asp:TextBox ID="TextBoxEmail" runat="server" CssClass="logtxt" MaxLength="20" onfocus='Showtips("spanEmail","请填写您常用的邮箱地址，以便找回密码等服务.")'
                            onblur="existemail()" autocomplete="off">
                        </asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="/imagecode.aspx?javascript:Math.random()" id="Img1" border="0" onclick="reloadcode()"
                                        alt="看不清,换一下" style="cursor: hand; vertical-align: middle; margin-left: 10px;" />
                                    <a style="cursor: pointer" onclick="reloadcode()">看不清,换一下1111</a> &nbsp;&nbsp;<span id="spanCode1"
                                        class="null"></span>
                                </td>
                            </tr>
                        </table>
                ...
                <div class="lbtn">
                    ...
                    <asp:Button ID="ButtonTwo" runat="server" OnClientClick="return agreement();" class="lobtn"
                        value="同意以上协议" Text="注册" />
