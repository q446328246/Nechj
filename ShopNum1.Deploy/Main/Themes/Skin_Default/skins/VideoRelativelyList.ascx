...
<div class="VideoHotBox">
    <ul>
        <asp:Repeater ID="RepeaterShow" runat="server">
            <ItemTemplate>
                <li><a href='<%# ShopUrlOperate.RetUrl("VideoDetail", Eval("Guid"))%>' class="VideoImg">
                ...
                </a><span class="VideoName"><a title="<%# ShopNum1.WebControl.VideoIsRecommendOrNewsList.GetSubstr(Eval("Title"),10,false)%>"
                ...
                </span><span class="VideoNum">播放次数<%# Eval("BroadcastCount")%>
