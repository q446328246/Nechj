        ...
        <asp:Repeater ID="RepeaterGrid" runat="server" EnableViewState="false">
            <ItemTemplate>
                <div class="product-wrap">
                    <div class="pro_img">
                        <a target="_blank" href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["ProductGuid"].ToString(),((DataRowView)Container.DataItem).Row["MemberID"].ToString(),"ProductDetail")%>">
                            <img src="<%# Page.ResolveUrl(((DataRowView)Container.DataItem).Row["ZtcImg"].ToString())+"_160x160.jpg"%>"
                                onerror="javascript:this.src='../ImgUpload/noimg.jpg_160x160.jpg'" /></a></div>
                    <div class="pro_name">
                        <a target="_blank" href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["ProductGuid"].ToString(),((DataRowView)Container.DataItem).Row["MemberID"].ToString(),"ProductDetail")%>"
                            title="<%#((DataRowView)Container.DataItem).Row["ZtcName"].ToString() %>" class="pname">
