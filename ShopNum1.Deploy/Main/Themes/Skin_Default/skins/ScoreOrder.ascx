...
<div class="sp_dialog_info">
    ...
    <p class="sp_general">
        ...
        <span id="SpanNumErr"></span><span id="SpanNumRight" style="display: block">
    ...
    <p class="sp_general">
        ...
        <span id="SpanMemLoginIDErr">*</span> <span id="SpanMemLoginIDRight" style="display: none">
            <img src="/ImgUpload/shopNum1Admin-right.gif" />
        </span>
    </p>
    ...
    <p class="sp_general">
        ...
        <span id="SpanPhoneErr">*</span> <span id="SpanPhoneRight" style="display: none">
            <img src="/ImgUpload/shopNum1Admin-right.gif" />
        </span>
    </p>
    <p class="sp_general">
        ...
        <span id="SpanPostalcodeErr">*</span> <span id="SpanPostalcodeRight" style="display: none">
            <img src="/ImgUpload/shopNum1Admin-right.gif" />
        </span>
    </p>
    ...
    <p class="sp_general">
        ...
        <span id="SpanEmailErr"></span><span id="SpanEmailRight" style="display: none">
            <img src="/ImgUpload/shopNum1Admin-right.gif" />
        </span>
    </p>
    <p class="sp_general">
        <label class="sp_lable">
            验证码：</label><asp:TextBox ID="TextBoxCode" onblur="funCheckYzm()" runat="server" CssClass="text textcode fl"
                Height="18px" Style="vertical-align: top; padding: 2px; margin: 0; width: 86px;"></asp:TextBox><span
                    style="padding-top: 2px;"><img src="/imagecode.aspx?javascript:Math.random()" id="safecode"
                        border="0" onclick="reloadcode()" alt="看不清?点一下" style="cursor: hand;" /></span><span
                            style="padding-top: 2px;"></span> <span id="SpanCodeErr"></span>
    ...
    <p class="sp_general" style="padding-top: 16px; text-align: center">
        ...
        </span><span class="login_info" style="display: none; float: right; font-weight: bold;
            color: Green" id="dataJzz">
            <img src="/Images/ajax_loading.gif" />红包商品订单生成中...</span>
    </p>
    <p class="sp_general">
    </p>
</div>
