...
<div class="shop_conts">
    <div class="paixu">
        ...
        <asp:LinkButton ID="LinkButtonRenqi" runat="server" CssClass="comSort" Visible="false"
            title="按人气从高到低">
            人气<i id="IRenqi" runat="server" class="comSort-d"></i></asp:LinkButton>
        <asp:LinkButton ID="LinkButtonMoren" runat="server" CssClass="comSort" title="默认">
            默认<i id="IMoren" runat="server" class="comSort-d"></i></asp:LinkButton>
        ...
        <asp:LinkButton ID="LinkButtonRuzhu" runat="server" CssClass="comSort">
            入驻时间<i id="IRuzhu" runat="server" class="comSort-d"></i></asp:LinkButton>
        <div class="shoprigth">
            店铺名称：
