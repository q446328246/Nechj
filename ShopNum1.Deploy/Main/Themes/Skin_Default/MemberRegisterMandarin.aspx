<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberRegisterMandarin.aspx.cs" Inherits="ShopNum1.Deploy.Main.Themes.Skin_Default.MemberRegisterMandarin" %>

<%@ Import Namespace="ShopNum1.Common" %>
<%@ Register Src="skins/MemberRegisterMandarin.ascx" TagName="MemberRegisterMandarin" TagPrefix="uc1" %>
...
<body style="background: #f6f6f6;">
    ...
    <div class="LoginBox m_top">
        <uc1:MemberRegisterMandarin ID="MemberRegisterMandarin1" runat="server" />
    </div>
    <!--//main End-->
    <!--foot Start-->
