...
{
    public partial class AuthenticationHtml5 : System.Web.UI.Page
    {
             ...
             ShopNum1_MemberShip_Action memberShipAction =
                    ...
                    DataTable memshipChongFu = memberShipAction.SearchShipRepeatMemLoginID(MemberLoginID, 1);
                        ...
                        else
                        {
                            ...
                            memberShip.ShopNames = this.TextBoxShopNames.ToString().Trim();
                            memberShip.Belongs = Textshebei.Text.Trim();
                            ...
                            memberShip.IdentityCardImage = "";
                            memberShip.LicenseImage = "";
                            ...
                            var usermessage = new List<string>
                        {
                            ...
                            Response.Write("<script>alert('恭喜');</script>");
