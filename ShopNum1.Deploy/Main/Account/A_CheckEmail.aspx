...
<%@ Register Src="Skin/A_CheckEmail.ascx" TagName="A_CheckEmail" TagPrefix="uc1" %>
    ...
    <div class="dpsc_mian">
        <p class="ptitle">
            <a href="A_Welcome.aspx">账户管理</a><span class="breadcrume_icon">>></span><a href="A_PwdSer.aspx">账户安全设置</a><span
                class="breadcrume_icon">>></span> <span class="breadcrume_text">邮箱设置交易密码</span></p>
        ...
        <uc1:A_CheckEmail ID="A_CheckEmail1" runat="server" />
        </form>
    </div>
</body>
</html>
