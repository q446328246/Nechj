<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A_UpPayPwd1.aspx.cs" Inherits="ShopNum1.Deploy.Main.Account.A_UpPayPwd1" %>

<%@ Register Src="Skin/A_UpPayPwd1.ascx" TagName="A_UpPayPwd1" TagPrefix="uc1" %>
    ...
    <div class="dpsc_mian">
        <p class="ptitle">
            <a href="A_Welcome.aspx">账户管理</a><span class="breadcrume_icon">>></span><a href="A_PwdSer.aspx">账户安全设置</a><span
                class="breadcrume_icon">>></span><span class="breadcrume_text">修改账户支付密码</span></p>
        <form id="fromPwd" runat="server">
        <%--        <ShopNum1Account:A_UpPwd ID="A_UpPwd" runat="server" SkinFilename="Skin/A_UpPwd.ascx" />--%>
        <uc1:A_UpPayPwd1 ID="A_UpPwd1" runat="server" />
        </form>
    </div>
</body>
</html>
