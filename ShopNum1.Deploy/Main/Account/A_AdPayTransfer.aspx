...
<%@ Register Src="Skin/A_AdPayTransfer.ascx" TagName="A_AdPayTransfer" TagPrefix="uc1" %>
...
<body>
    <div class="dpsc_mian">
        <p class="ptitle">
            <a href="A_Welcome.aspx">账户管理</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">人民币转账</span></p>
        ...
        <%--        <ShopNum1Account:A_AdPayTransfer ID="A_AdPayTransfer" runat="server" SkinFilename="Skin/A_AdPayTransfer.ascx"
            PageSize="10" />--%>
        <uc1:A_AdPayTransfer ID="A_AdPayTransfer1" runat="server" PageSize="10" />
        </form>
    </div>
