...
<%@ Register Src="Skin/A_AdPayTransfer_Rv_Bv.ascx" TagName="A_AdPayTransfer_Rv_Bv" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>财务管理-人民币（RV）转金币（BV）</title>
...
<body>
    <div class="dpsc_mian">
        <p class="ptitle">
            <a href="A_Welcome.aspx">账户管理</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">人民币（RV）转金币（BV）</span></p>
        ...
        <%--        <ShopNum1Account:A_AdPayTransfer ID="A_AdPayTransfer" runat="server" SkinFilename="Skin/A_AdPayTransfer.ascx"
            PageSize="10" />--%>
        <uc1:A_AdPayTransfer_Rv_Bv ID="A_AdPayTransfer_Rv_Bv1" runat="server" PageSize="10" />
        </form>
    </div>
