...
<%@ Register Src="Skin/A_AdPayTransfer_Tj88.ascx" TagName="A_AdPayTransfer_Tj88" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>财务管理-从Tj88提款</title>
...
<body>
    <div class="dpsc_mian">
        <p class="ptitle">
            <a href="A_Welcome.aspx">账户管理</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">从Tj88提款</span></p>
        ...
        <%--        <ShopNum1Account:A_AdPayTransfer ID="A_AdPayTransfer" runat="server" SkinFilename="Skin/A_AdPayTransfer.ascx"
            PageSize="10" />--%>
        <uc1:A_AdPayTransfer_Tj88 ID="A_AdPayTransfer_Tj881" runat="server" PageSize="10" />
        </form>
    </div>
