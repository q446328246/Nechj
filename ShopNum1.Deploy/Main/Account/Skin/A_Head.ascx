<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="A_Head.ascx.cs" Inherits="ShopNum1.Deploy.Main.Account.Skin.A_Head" %>
...
<div id="top">
    ...
    <!--消息提醒-->
    <div class="xiaoxi">
        <a href="/main/member/m_index.aspx?tomurl=M_SysMsg.aspx?isread=0&pageid=1">消息提醒：您有(
            <span style="font-size: 14px; color: #ff6600; font-family: Arial;">
                <asp:Label ID="LabelMsg" runat="server" Text="0"></asp:Label></span> )封未读系统信息......
        </a>
    </div>
    <div class="top_list">
