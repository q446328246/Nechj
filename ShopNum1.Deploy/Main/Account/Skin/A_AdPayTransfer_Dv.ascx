<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="A_AdPayTransfer_Dv.ascx.cs"
    Inherits="ShopNum1.Deploy.Main.Account.Skin.A_AdPayTransfer_Dv" %>
...
<div id="list_main" class="list_main1">
    <ul id="sidebar">
        <li class='<%=ShopNum1.Common.Common.ReqStr("type")=="0"||ShopNum1.Common.Common.ReqStr("type")==""?"TabbedPanelsTab TabbedPanelsTabSelected":"TabbedPanelsTab" %>'>
            <a href="A_AdPayTransfer_Dv.aspx?type=0" style="text-decoration: none;">转账</a></li>
