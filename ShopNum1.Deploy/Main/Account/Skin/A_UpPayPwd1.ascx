<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="A_UpPayPwd1.ascx.cs" Inherits="ShopNum1.Deploy.Main.Account.Skin.A_UpPayPwd1" %>
<div id="content">
    <div>
...
<%--            <tr>
            ...
            <tr>
                <td class="tab_r">
                    <span style="color: red;">*</span>确认支付密码：
                </td>
                <td>
...
<script type="text/javascript" language="javascript">
    ...
    $(function () {
        $("#<%= Input_NewPwd.ClientID %>").focus(function () {
            ...
            context.innerHTML = "请输入6~15位支付密码";
