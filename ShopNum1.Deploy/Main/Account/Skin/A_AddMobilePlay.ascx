<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="A_AddMobilePlay.ascx.cs" Inherits="ShopNum1.Deploy.Main.Account.Skin.A_AddMobilePlay" %>

<%@ Import Namespace="ShopNum1.Common" %>
<div id="list_main" class="list_main1">
    <ul id="sidebar">
        <li class="TabbedPanelsTab TabbedPanelsTabSelected"
            id="0"><a href="A_AddMobilePlay.aspx" style="text-decoration: none;">转账到闲时游</a></li>
