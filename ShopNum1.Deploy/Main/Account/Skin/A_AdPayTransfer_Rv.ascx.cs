...
{
    public partial class A_AdPayTransfer_Rv : BaseMemberControl
    {
        ...
        private void BindData()
        {
            ...
            try
            {
                ...
                pageDiv.InnerHtml =
                    new PageListBll("main/Account/A_AdPayTransfer_Rv.aspx", true).GetPageListNew(pl);
                    ...
                    else
                    {
                        ...
                        else if (action.CheckmemLoginIDtwo(txt_TransferID.Value.Trim(), txt_TransferName.Value.Trim()) > 0)
                        {
                            ...
                            if (Common.Encryption.GetMd5SecondHash(input_PayPwd.Value.Trim()) == str2)
                            {
                                ...
                                switch (
                                    action.Transfer_Rv(base.MemLoginID, strMemID, txt_Transfer.Value.Trim()))
                                {
                                    case -1:
                                    ...
                                    case 1:
                                        ...
                                        MoneyModifyLog(strMemID.Trim(), txt_Transfer.Value.Trim(), table.Rows[0]["Score_rv"].ToString(), "1", "会员" + base.MemLoginID + "转账￥" + txt_Transfer.Value.Trim() + "给您");
        ...
        protected void Btn_Select_Click(object sender, EventArgs e)
        {
            ...
            str = (str == "") ? "0" : str;
            Page.Response.Redirect("A_AdPayTransfer_Rv.aspx?Type=" + str + "&pageid=1&StartTime=" + strStartTime +
        ...
        protected void MoneyModifyLog(string memloginID, string money, string CurrentScore_rv, string type, string string_8)
        {
