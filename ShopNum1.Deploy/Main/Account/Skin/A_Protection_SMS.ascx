<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="A_Protection_SMS.ascx.cs" Inherits="ShopNum1.Deploy.Main.Account.Skin.A_Protection_SMS" %>
        ...
        <div class="ps_width clearfix">
            <div class="zhszmian1">
                <ul class="mimbz">
                    ...
                    <li class="bztwo" id="li_get">2.设置开启或取消资金保护</li>
