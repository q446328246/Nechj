<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="S_SellGoods_Two.aspx.cs" Inherits="ShopNum1.Deploy.Shop.ShopAdmin.S_SellGoods_Two1" %>
        ...
        <div id="content_bg">
            <div class="con_order">
                ...
                <div class="tisc_light" style="border-bottom: solid 1px #e8e8e8;">
                    ...
                    <ShopNum1ShopAdmin:S_OpGoods1 ID="S_OpGoods1CV" runat="server" SkinFilename="Skin/S_OpGoods1CV.ascx" />
