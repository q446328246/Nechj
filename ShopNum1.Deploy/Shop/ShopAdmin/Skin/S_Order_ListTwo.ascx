...
<% DataTable dt = S_Order_ListTwo.dt_OrderList;
...
<script type="text/javascript" language="javascript">
    $(function () {
        ...
        $("#sk").click(function () {
            ...
            location.href = "S_Order_ListTwo.aspx?ostate=" + ostate + "&sstate=" + sstate + "&pstate=" + pstate + "&stype=" + stype + "&pn=" + escape($("#pname").val()) + "&ord=" + $("#ordernum").val() + "&sd=" + $("#txtstartdate").val() + "&ed=" + $("#txtenddate").val() + "&mid=" + escape($("#memloginid").val()) + "&st=" + st + "&";
        });
        // 全选
    ...
    function ontoPage(o) {
        ...
        if (checknum(pageindex)) {
            ...
            if (pageEnd <= pageindex)
                pageindex = pageEnd;
            location.href = "S_Order_ListTwo.aspx?pageid=" + pageindex;
        }
    }
</script>
<script type="text/javascript" language="javascript">
    ...
    function surecheck(guid, ordernumber, payname, memloginid) {
        ...
        funOpen();
        $(".showpoptwo").show();
        $("#S_Order_ListTwo_ctl00_hidOrderGuId").val(guid);
        ...
        <% if (dt != null)
           {
               ...
               for (int i = 0; i < dt.Rows.Count; i++)
               {
                   ...
                   DataRow[] drr = S_Order_ListTwo.dt_GetOrderProduct(dr["guid"].ToString()).Select();
                   if (drr.Length != 0)
                   {
        %>
        <!--列表标题-->
        <table width="100%" border="0" cellspacing="0" cellpadding="5" class="blue_tbw" id="Table1">
            <tr>
                ...
                <th class="th_color th_ri">
                    订单状态：<span><%= S_Order_ListTwo.setOrderState(strOrderState)%></span>
                </th>
            </tr>
        </table>
        <!--列表内容-->
