            ...
            <table border="0" cellspacing="0" cellpadding="0" class="lineh">
                <tbody>
                    <tr class="up_spac">
                        ...
                        <td>
                            <input type="text" class="ss_nr1" name="ProductName" value="<%= ShopNum1.Common.Common.ReqStr("pn") %>" />
                        </td>
                    ...
                    <tr class="up_spac">
                        ...
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td>
                                        <input type="text" class="ss_nr1" name="Number" value="<%= ShopNum1.Common.Common.ReqStr("no") %>" />
                                    </td>
                                    <td>
        ...
        <table width="100%" cellspacing="0" id="Maintab_<%= dr["id"] %>" cellpadding="5"
            ...
            <tr>
                <th style="border-left: solid 1px #e3e3e3; text-align: right; width: 48px;">
                    <div class="ord_check" style="display: none; padding-top: 0;">
            ...
            <tbody>
                <tr>
                    <td style="border-left: solid 1px #e3e3e3;" colspan="2">
                        <a href="<%= ShopUrlOperate.shopHref(dr["guid"].ToString(), dr["memloginid"].ToString()) %>"
                    ...
                    <td style="width: 110px;">
                        ...
                        <a class="alink_blue" href="<%= strProductUrl %>" target="_blank">查看</a> <a class="alink_blue"
                            target="_blank" href="S_SellGoods_two.aspx?op=edit&ctype=<%= dr["ctype"] %>&pid=<%= dr["guid"] %>&code=<%= dr["productcategorycode"] %>">
                            编辑</a>
                    </td>
                </tr>
            </tbody>
