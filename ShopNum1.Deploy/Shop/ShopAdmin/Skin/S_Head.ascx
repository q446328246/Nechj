...
<div id="top">
    ...
    <div class="fl_left">
        ...
        [<span style="color: #005ea7;"><asp:LinkButton ID="ButtonOut" runat="server" Text="退出"></asp:LinkButton></span>]
    </div>
    <!--消息提醒-->
    <div class="xiaoxi">
        <a href="/main/member/m_index.aspx?tomurl=M_Msg.aspx?isread=0&pageid=1">消息提醒：您有( <span
            style="color: #ff6600; font-family: Arial; font-size: 14px;">
            <asp:Label ID="LabelMsg" runat="server" Text="0"></asp:Label></span> )封未读会员信息...
        </a>
    </div>
    <div class="top_list">
        ...
        <div class="top_hert allsort fl">
            ...
            <div class="sub_customer">
                ...
                <a href="http://kehubaomall.t.com/shopadmin/login.aspx" class="lo2" target="_blank">
                    客户宝CRM</a>
            </div>
        </div>
    ...
    <div id="nav">
        <div id="gwc">
            <a href="/Main/ShoppingCart1.aspx" target="_blank">您的购物车有 <span class="green_bold">
                <asp:Label ID="LabelGouWuChe" runat="server" Text="0"></asp:Label></span> 件商品
            </a>
        </div>
        <!--菜单项nav-->
        <ul style="float: left;">
            <li><a href="/main/member/m_index.aspx">个人中心</a></li>
            <li class="line"><span></span></li>
            <li><a href="/shop/ShopAdmin/s_index.aspx" class="zh">我是卖家</a></li>
            <li class="line"><span></span></li>
            <li><a href="/main/account/A_Index.aspx">账户管理</a></li>
            <%--<li><a href="/main/Bourse/B_Index.aspx">原料中心</a></li>--%>
        </ul>
    </div>
</div>
<div style="clear: both;">
