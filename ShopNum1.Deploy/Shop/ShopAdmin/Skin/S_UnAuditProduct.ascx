...
<script type="text/javascript" language="javascript">
    $(function () {
        ...
        $("#tselect1").change(function () {
            $("#tselect2").html("<option value=\"00\">-请选择-</option>");
        ...
        $(".shanchu").click(function () {
            if (confirm("是否执行批量删除操作？")) {
                ...
                window.location.href = "S_UnAuditProduct.aspx";
...
<div id="list_main">
    <div class="ordmain1" id="content">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="blue_tb12"
            ...
            <tr>
                <th style="border-left: solid 1px #e3e3e3; text-align: right; width: 26px;">
                ...
                <th style="border-right: solid 1px #e3e3e3; text-align: left;">
                    ...
                    添加时间：<%= dr["ModifyTime"] %>
                    &nbsp;&nbsp; &nbsp;&nbsp;<%= dr["IsAudit"].ToString() == "2" ? "<font color='red'>审核未通过</font>" : "暂未审核" %>
                </th>
            </tr>
        </table>
