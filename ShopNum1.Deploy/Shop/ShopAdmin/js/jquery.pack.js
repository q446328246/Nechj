...
(function(z, v) {
    ...
    function oa(a, b) { return "live." + (a ? a + "." : "") + b.replace(/\./g, "`").replace(/ /g, "&"); }
    ...
    function K(a, b) {
        var d = {};
        c.each(ta.concat.apply([], ta.slice(0, b)), function() { d[this] = a; });
        return d;
    }

    function ua(a) { return "scrollTo" in a && a.document ? a : a.nodeType === 9 ? a.defaultView || a.parentWindow : false; }

    var c = function(a, b) { return new c.fn.init(a, b); }, Na = z.jQuery, Oa = z.$, r = z.document, S, Pa = /^[^<]*(<[\w\W]+>)[^>]*$|^#([\w-]+)$/, Qa = /^.[^:#\[\.,]*$/, Ra = /\S/, Sa = /^(\s|\u00A0)+|(\s|\u00A0)+$/g, Ta = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, O = navigator.userAgent,
    ...
    c.extend({
        ...
        trim: function(a) { return (a || "").replace(Sa, ""); },
    ...
    if (wa) c.inArray = function(a, b) { return wa.call(b, a); };
    S = c(r);
    if (r.addEventListener)
        L = function() {
            ...
            return this.each(function(o) {
                ...
                if (this.nodeType === 1) {
                    ...
                    if (c.isArray(s) && za.test(this.type)) this.checked = c.inArray(m.val(), s) >= 0;
                        ...
                        var x = c.makeArray(s);
                        c("option", this).each(function() { this.selected = c.inArray(c(this).val(), x) >= 0; });
    ...
    var ab = function(a) { return a.replace(/[^\w\s\.\|`]/g, function(b) { return "\\" + b; }); };
    c.event = {
        add: function(a, b, d, f) {
            if (!(a.nodeType === 3 || a.nodeType === 8)) {
                ...
                if (!i) {
                    j =
                        function() { return typeof c !== "undefined" && !c.event.triggered ? c.event.handle.apply(j.elem, arguments) : v; };
                    i = c.data(a, "handle", j);
                }
                if (i) {
                    i.elem = a;
        ...
        trigger: function(a, b, d, f) {
            ...
            if (!f) {
                ...
                if (!d) {
                    a.stopPropagation();
                    this.global[e] && c.each(c.cache, function() { this.events && this.events[e] && c.event.trigger(a, b, this.handle.elem); });
                }
            ...
            live: {
                ...
                remove: function(a) {
                    if (a.length) {
                        var b =
                                0, d = new RegExp("(^|\\.)" + a[0] + "(\\.|$)");
                        c.each(c.data(this, "events").live || {}, function() { d.test(this.type) && b++; });
    ...
    c.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function(a, b) { c.event.special[a] = { setup: function(d) { c.event.add(this, b, d && d.selector ? Ba : Aa, a); }, teardown: function(d) { c.event.remove(this, b, d && d.selector ? Ba : Aa); } }; });
    ...
    c.each(["bind", "one"], function(a, b) {
        c.fn[b] = function(d, f, e) {
            ...
            return d === "unload" && b !== "one" ? this.one(d, f, e) : this.each(function() { c.event.add(this, d, j, f); });
        };
    });
    c.fn.extend({
        unbind: function(a,
            ...
            return this.each(function() { c.event.remove(this, a, b); });
        },
    ...
    c.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "), function(a, b) {
        c.fn[b] = function(d) { return d ? this.bind(b, d) : this.trigger(b); };
    ...
    (function() {
        ...
        o.matches = function(g, h) { return o(g, null, null, h); };
        ...
        o.error = function(g) { throw "Syntax error, unrecognized expression: " + g; };
        var m = o.selectors = {
            order: ["ID", "NAME", "TAG"],
            match: {
                ID: /#((?:[\w\u00c0-\uFFFF-]|\\.)+)/,
            ...
            find: {
                ID: function(g, h, k) { if (typeof h.getElementById !== "undefined" && !k) return (g = h.getElementById(g[1])) ? [g] : []; },
                NAME: function(g, h) {
            ...
            setFilters: {
                first: function(g, h) { return h === 0; },
                last: function(g, h, k, l) { return h === l.length - 1; },
                even: function(g, h) {
                    return h % 2 ===
                        0;
                },
                odd: function(g, h) { return h % 2 === 1; },
                lt: function(g, h, k) { return h < k[3] - 0; },
                gt: function(g, h, k) { return h > k[3] - 0; },
                nth: function(g, h, k) { return k[3] - 0 === h; },
                eq: function(g, h, k) { return k[3] - 0 === h; }
            },
            filter: {
        ...
        for (var x in m.match) {
            ...
            m.leftMatch[x] = new RegExp(/(^(?:.|\r|\n)*?)/.source + m.match[x].source.replace(/\\(\d+)/g, function(g, h) { return "\\" + (h - 0 + 1); }));
        }
        var A = function(g, h) {
        ...
        (function() {
            ...
            if (r.getElementById(h)) {
                m.find.ID = function(l, q, p) { if (typeof q.getElementById !== "undefined" && !p) return (q = q.getElementById(l[1])) ? q.id === l[1] || typeof q.getAttributeNode !== "undefined" && q.getAttributeNode("id").nodeValue === l[1] ? [q] : v : []; };
        ...
        (function() {
            ...
            if (!(!g.getElementsByClassName || g.getElementsByClassName("e").length ===
                ...
                if (g.getElementsByClassName("e").length !== 1) {
                    ...
                    m.find.CLASS = function(h, k, l) { if (typeof k.getElementsByClassName !== "undefined" && !l) return k.getElementsByClassName(h[1]); };
                    g = null;
                }
            }
        })();
    ...
    var Ea = function(a, b, d) {
        if (c.isFunction(b)) return c.grep(a, function(e, i) { return !!b.call(e, i, e) === d; });
        else if (b.nodeType)
            return c.grep(a,
                function(e) { return e === b === d; });
    ...
    c.fn.extend({
        ...
        not: function(a) { return this.pushStack(Ea(this, a, false), "not", a); },
        filter: function(a) { return this.pushStack(Ea(this, a, true), "filter", a); },
    ...
    c.fn.extend({
        ...
        before: function() {
            if (this[0] && this[0].parentNode)
                return this.domManip(arguments,
                    false, function(b) { this.parentNode.insertBefore(b, this); });
        ...
        after: function() {
            if (this[0] && this[0].parentNode) return this.domManip(arguments, false, function(b) { this.parentNode.insertBefore(b, this.nextSibling); });
            else if (arguments.length) {
        ...
        html: function(a) {
            if (a === v) return this[0] && this[0].nodeType === 1 ? this[0].innerHTML.replace(Fa, "") : null;
                ...
                c.isFunction(a) ? this.each(function(e) {
                    ...
                    i.empty().append(function() { return a.call(this, e, j); });
                }) : this.empty().append(a);
            return this;
        },
        ...
        domManip: function(a, b, d) {
            ...
            function f(s) { return c.nodeName(s, "table") ? s.getElementsByTagName("tbody")[0] || s.appendChild(s.ownerDocument.createElement("tbody")) : s; }

            var e, i, j = a[0], n = [];
            if (!c.support.checkClone && arguments.length === 3 && typeof j ===
                "string" && sa.test(j)) return this.each(function() { c(this).domManip(a, b, d, true); });
            if (c.isFunction(j))
    ...
    }, function(a, b) { c.fn[a] = function() { return this.each(b, arguments); }; });
    c.extend({
    ...
    var hb = /z-?index|font-?weight|opacity|zoom|line-?height/i,
        Ja = /alpha\([^)]*\)/, Ka = /opacity=([^)]*)/, ga = /float/i, ha = /-([a-z])/ig, ib = /([A-Z])/g, jb = /^-?\d+(?:px)?$/i, kb = /^-?\d/, lb = { position: "absolute", visibility: "hidden", display: "block" }, mb = ["Left", "Right"], nb = ["Top", "Bottom"], ob = r.defaultView && r.defaultView.getComputedStyle, La = c.support.cssFloat ? "cssFloat" : "styleFloat", ia = function(a, b) { return b.toUpperCase(); };
    ...
    c.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() { return this.elements ? c.makeArray(this.elements) : this; }).filter(function() {
                ...
                a = c(this).val();
                return a == null ? null : c.isArray(a) ? c.map(a, function(d) { return { name: b.name, value: d }; }) : { name: b.name, value: a };
            }).get();
        }
    });
    ...
    c.extend({
        ...
        ajaxSettings: {
            ...
            processData: true,
            async: true,
            xhr: z.XMLHttpRequest && (z.location.protocol !== "file:" || !z.ActiveXObject) ? function() { return new z.XMLHttpRequest; } :
                function() {
                    try {
        ...
        ajax: function(a) {
            ...
            if (w) {
                ...
                e.async && e.timeout > 0 && setTimeout(function() { w && !E && g("timeout"); }, e.timeout);
                try {
        ...
        param: function(a, b) {
            ...
            function d(j, n) {
                ...
                else !b && n != null && typeof n === "object" ? c.each(n, function(o, m) { d(j + "[" + o + "]", m); }) : f(j, n);
            }
    ...
    c.fn.offset = "getBoundingClientRect" in r.documentElement ? function(a) {
        ...
        var b = this[0];
        if (a) return this.each(function(s) { c.offset.setOffset(this, a, s); });
        if (!b || !b.ownerDocument) return null;
        if (b === b.ownerDocument.body) return c.offset.bodyOffset(b);
        c.offset.initialize();
