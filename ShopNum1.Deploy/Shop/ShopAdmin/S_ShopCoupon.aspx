...
<body>
    ...
    <div class="dpsc_mian">
        <p class="ptitle">
            <a href="S_Welcome.aspx">我是卖家</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">优惠券管理</span></p>
        <ShopNum1ShopAdmin:S_ShopCoupon ID="S_ShopCoupon" runat="server" SkinFilename="Skin/S_ShopCoupon.ascx"
            PageSize="10" />
    </div>
