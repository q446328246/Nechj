...
<div style="margin-top: 5px;">
    <div class="daohang" style="padding-left:30px;">
        发表评论</div>
            ...
            <table width="100%" border="0" cellpadding="3">
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <img src="imagecode.aspx" id="Img1" border="0" onclick="reloadcode()" alt="看不清?点一下"
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="ButtonConfrim" runat="server" Text="我要留言" CssClass="bnt1" />
                    </td>
                </tr>
            </table>
        </div>
    ...
    <asp:Panel ID="PanelOut" runat="server">
        <div  style="border:1px solid #D4D4D4; padding:20px; " class="pada">
            请先
