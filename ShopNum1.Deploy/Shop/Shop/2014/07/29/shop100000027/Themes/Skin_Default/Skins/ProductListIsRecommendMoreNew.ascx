            ...
            <asp:Repeater ID="RepeaterDataGrid" runat="server">
                <ItemTemplate>
                    ...
                    <div class="pruct_zs">
                        <div class="pdt_img">
                            <p class="ncs_img">
                                <a href='<%# GetPageName.RetUrlcenter("ProductDetail",Eval("guid"),Eval("shop_category_id").ToString())%>' target="_blank"
                                    title='<%# Eval("Name")%>'>
        ...
        else if (Page.Request.Cookies["category"] != null)
        {
         ...
         %>
                    ...
                    <% }
                        ...
                        { %>
                        <p class="pdt_price" >
                        <strong>￥<asp:Literal ID="Literal2" runat="server" Text='<%# Convert.ToDecimal(Eval("Score_dv"))*-1%>'></asp:Literal></strong>
                    </p>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width: 220px;">
                                    <p class="pdt_name">
                                        <span runat="server" visible="false" id="guid"><%# Eval("Guid") %></span><a href='<%# GetPageName.RetUrlcenter("ProductDetail",Eval("guid"),Eval("shop_category_id").ToString())%>'
