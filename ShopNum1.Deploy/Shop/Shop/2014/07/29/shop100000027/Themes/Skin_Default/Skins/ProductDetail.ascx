...
<div class="detail">
    <div class="DetailImage">
        <h1 class="title">
            <span>
                <asp:Label ID="LabelName" runat="server"></asp:Label></span>
        </h1>
        <div class="content">
            <!--预览图片-->
                                    ...
                                    <ItemTemplate>
                                        <li class="tb_diply">
                                            <div class="tb-pic tb-stn">
                                                <a>
                                                    <img id="Img1" height="56" width="56" runat="server" src='<%# Eval("imgurl")+"_60x60.jpg" %>'
                                                        lang='<%# Eval("imgurl")%>' /></a>
                                            </div>
                                        </li>
                                    </ItemTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="collection" colspan="2">
                            <span class="enshrine">
                                <asp:Button ID="ButtonCollect" runat="server" title="收藏该商品" Text="收藏该商品" OnClientClick="return loadLogin();"
                                    CssClass="sc" />
                            </span>
                        </td>
                    </tr>
                    <tr id="trMarketPrice" runat="server" style="display:none">
                        <td class="NameWid">
                            市 场 价：
                        </td>
                    ...
                    <tr id="tr_dv" runat="server">
                        <td>
                            <asp:Label ID="Label_dv" runat="server" Text="本 店 价："></asp:Label>
                        </td>
                        <td class="ShopPrice">
                            <asp:Label ID="LabeScore_dv" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr id="trShopPrice" runat="server">
                        <td>
                            <asp:Label ID="lblPriceTxt" runat="server" Text="商 品 价："></asp:Label>
                        </td>
                        <td class="ShopPrice">
                            <asp:Label ID="LabelShopPrice" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr id="tr_Pv_a" runat="server">
                        <td class="style1">
                            <asp:Label ID="Label_Pv_a" runat="server" Text="可得新能源链："></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:Label ID="LabeScore_Pv_a" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr id="tr_max_hv" runat="server">
                        <td class="style1">
                            <asp:Label ID="Label_max_hv" runat="server" Text="可用联盟消费券："></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:Label ID="LabeScore_max_hv" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr id="tr_cv" runat="server">
                        <td class="style1">
                            <asp:Label ID="Label_cv" runat="server" Text="可用积分："></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:Label ID="LabeScore_cv" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr id="tr_Pv_b" runat="server">
                        <td>
                            <asp:Label ID="Label_Pv_b" runat="server" Text="可得积分："></asp:Label>
                        </td>
                        <td class="ShopPrice">
                            <asp:Label ID="LabeScore_Pv_b" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr id="tr_Pv_cv" runat="server">
                        <td>
                            <asp:Label ID="Label_Pv_cv" runat="server" Text="可得积分："></asp:Label>
                        </td>
                        <td class="ShopPrice">
                            <asp:Label ID="LabeScore_Pv_cv" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr id="tr_hv" runat="server">
                        <td>
                            <asp:Label ID="Label_hv" runat="server" Text="可得红包："></asp:Label>
                        </td>
                        <td class="ShopPrice">
                            <asp:Label ID="LabeScore_hv" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr id="tr_sv" runat="server">
                        <td>
                            <asp:Label ID="Label_sv" runat="server" Text="捐慈善款："></asp:Label>
                        </td>
                        <td class="ShopPrice">
                            <asp:Label ID="LabeScore_sv" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr id="trDisCount" runat="server" visible="false">
                        ...
                        <td>
                            ...
                            <span id="spansaletxt" runat="server" class="disCount" style="color: White; background: red;">
                                限时折扣</span> <strong style="margin-right: 6px;"><b class="jg_store">￥<asp:Label ID="lblPromotionPrice"
                                    runat="server"></asp:Label></b></strong>
                            <asp:Label ID="lblTipDisCount" runat="server" Visible="false"></asp:Label><span id="spTimego"><asp:Literal
                                ID="literTime" runat="server"></asp:Literal></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr id="cellFee1" runat="server" style=" display:none">
                        <td>
                            运&nbsp;&nbsp;&nbsp;&nbsp;费：
                        </td>
                        <td class="freight">
                    ...
                    <tr id="cellFee2" runat="server">
                        ...
                        <td>
                            <div class="area_tn">
                                至 <a href="javascript:ShowHideRegion('show')" id="ahrefregionname">全国</a>
                                        ...
                                        <tr style="display: none;">
                                            <td colspan="4">
                                                <div class="SubArea clearfix">
                                                    <a>全国</a><a>全国</a><a>全国</a><a>全国</a><a>全国</a><a>全国</a> <a>全国</a><a>全国</a><a>全国</a><a>全国</a><a>全国</a><a>全国</a><a>全国</a>
                    ...
                    <tr style="display: none">
                        ...
                        <td>
                            <span style="color: #3C3C3C; font-size: 12px; width: 150px;"></span><span style="color: #D40000;
                                font-size: 13px;"></span>分/<asp:Label ID="lblUnitName" runat="server"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td class="stock">
                            <span class="scan">
                                <asp:Label ID="lblSaleNumber" runat="server" ForeColor="Green"></asp:Label></span><%=lblUnitName.Text==""?"件":lblUnitName.Text%>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <span class="scan">
                                <asp:Label ID="lblClickCount" runat="server"></asp:Label></span>次
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <span class="stow">
                                <asp:Label ID="lblCollectCount" runat="server"></asp:Label></span>次
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <dl class="BuyingNum clearfix">
                                <dd class="clearfix">
                                    ...
                                    <span class="decrease"></span>库存<asp:Label ID="LabelRepertoryCount" CssClass="storage"
                                        runat="server"></asp:Label><%=lblUnitName.Text==""?"件":lblUnitName.Text%>
                                </dd>
                            </dl>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Button ID="ButtonBuy" runat="server" title="立刻购买" CssClass="bnt_buynow fl" OnClientClick="return checkSubmit(1)"
                                OnClick="ButtonBuy_Click" />
                            <asp:Button ID="ButtonShopCar" runat="server" title="加入购物车" CssClass="bnt_addcart fl"
                                OnClientClick="return checkSpec();" />
                            <span class="enshrine" style="width: 408px; display: none;">
                                <asp:Button ID="btn" runat="server" title="预约购买" Text="预约购买" OnClientClick="return popRemark();"
                                    CssClass="sc" />(免费发送本品牌地址/联系方式/商品信息到您的手机，预约免费量尺打预算。) </span>
                            <div class="shopcart_popup" style="display: none;">
                                <dl>
                                    ...
                                    <dd>
                                        <p class="mb5">
                                            购物车共有 <strong id="bold_num">1</strong> 种商品 总金额为：<em class="price" id="bold_mly">￥99.00</em></p>
                                        <p>
                                            <input type="submit" onclick="location.href='http://www.xmultibuy.cn/index.php?act=cart'"
                                                value="查看购物车" name="" class="btn1">
                                            <input type="submit" onclick="$('.shopcart_popup').css({'display':'none'});" value="继续购物"
                                                name="" class="btn2">
                                        </p>
                                    </dd>
                                </dl>
...
<script type="text/javascript" language="javascript">
    ...
    var locurl = 'http://<%=Request.Url.Host %>/poplogin.aspx?vj=shopcar&backurl=' + encodeURIComponent('http://<%=Request.Url.Host %>/productdetail.aspx?guid=<%=Request.QueryString["guid"] %>');
</script>
...
<div class="combination" id="divCombin" runat="server">
    <div class="data">
        ...
        <ul class="data-list clearfix">
            ...
            <li class="data-main">
                <div class="tb-pic tb-s80">
                    <a href="<%=strUrl %>">
                        <img src="<%=strProductPic %>_60x60.jpg" alt="<%=strPname %>" /></a>
                </div>
                <a href="<%=strUrl %>" class="tb-title">
                    <%=strPname %></a> <em class="tb-price tb-rmb-num">原价：<em class="tb-rmb">¥</em><%=strShopPrice %></em>
            </li>
            <%}
              else if (i == 1)
              { %>
        ...
        <div class="data-info">
            <p class="tb-total">
                <span>套餐价格：</span> <em class="tb-rmb">¥</em> <em class="tb-rmb-num">
                    <asp:Label ID="lblPackSalePrice" runat="server"></asp:Label></em>
            </p>
            <p class="tb-save">
                <span>节省：</span> <em class="tb-rmb">¥</em> <em class="tb-rmb-num">
                    <asp:Label ID="lblSavePrice" runat="server"></asp:Label></em>
            </p>
