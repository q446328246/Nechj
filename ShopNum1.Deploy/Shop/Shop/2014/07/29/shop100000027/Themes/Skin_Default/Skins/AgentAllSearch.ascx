...
<div class="FormBox">
    <div class="mallSearch_input clearfix">
        ...
        <asp:Button ID="ButtonIn" runat="server" Text="" CssClass="search_buttom1" CausesValidation="False" OnClientClick='form.target="_blank";' />
         <!--店外 -->  
        <div style="display:none;"><asp:Button ID="ButtonAllSearch" runat="server" Text="" CssClass="search_buttom" CausesValidation="False" OnClientClick='form.target="_blank";' /></div>      
    </div>
</div>
