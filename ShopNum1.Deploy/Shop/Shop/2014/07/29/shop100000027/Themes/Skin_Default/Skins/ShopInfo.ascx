    ...
    <div class="ks_panel_tab">
        ...
        else if (Page.Request.Cookies["category"] != null)
        {
            category = Page.Request.Cookies["category"].Value;
                            ...
                            <% if (category=="1")
                               {%>
		                 <img id="Img2" runat="server" height="64" src='../../../../../../../../ShopAdmin/images/logodfwe_DaTang.jpg'
                             width="64" />
	                           <% } %>
                               <% if (category=="2")
                               {%>
		                 <img id="Img3" width="64" height="64" src='../../../../../../../../ShopAdmin/images/logodfwe_Vip.jpg' runat="server" />
	                           <% } %>
                               <% if (category=="3")
                               {%>
		                 <img id="Img4" width="64" height="64" src='../../../../../../../../ShopAdmin/images/logodfwe_JiIFen.jpg' runat="server" />
	                           <% } %>
                               <% if (category=="4")
                               {%>
		                 <img id="Img5" width="64" height="64" src='../../../../../../../../ShopAdmin/images/logodfwe_QDSQ.jpg' runat="server" />
	                           <% } %>
                               <% if (category=="5")
                               {%>
		                 <img id="Img1" width="64" height="64" src='../../../../../../../../ShopAdmin/images/logodfwe_QDSQ.jpg' runat="server" />
	                           <% } %>
                               <% if (category=="6")
                               {%>
		                 <img id="Img6" width="64" height="64" src='../../../../../../../../ShopAdmin/images/logodfwe_QDSQ.jpg' runat="server" />
	                           <% } %>
                               <% if (category=="7")
                               {%>
		                 <img id="Img7" width="64" height="64" src='../../../../../../../../ShopAdmin/images/logodfwe_QDSQ.jpg' runat="server" />
	                           <% } %> <% if (category=="8")
                               {%>
		                 <img id="Img8" width="64" height="64" src='../../../../../../../../ShopAdmin/images/logodfwe_QDSQ.jpg' runat="server" />
	                           <% } %>
                            </dt>
                            <%--<dd class="ncs_name">
                                <a class="shopkps">
