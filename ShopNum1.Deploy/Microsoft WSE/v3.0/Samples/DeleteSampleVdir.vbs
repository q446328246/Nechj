...
Else
   errorString = "Unable to delete Virtual directory. Maybe IIS is not installed. Install IIS by choosing the Application Server component in Add/Remove Windows Components from the Control Panel" 
