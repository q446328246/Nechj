...
If Err.Number > 0 Then
    errorString = Err.Description & " IIS is not installed. Install IIS by choosing the Application Server component in Add/Remove Windows Components from the Control Panel" 
