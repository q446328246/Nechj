<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Alipay2return_url.aspx.cs"
    Inherits="ShopNum1.Deploy.PayReturn.Alipay2return_url" %>
...
<body>
    ...
    <table align="center" width="350" cellpadding="5" cellspacing="0">
        ...
        <tr>
            ...
            <td class="font_content" align="left">
                <asp:Label ID="lbOut_trade_no" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="font_content" align="right">
            ...
            <td class="font_content" align="left">
                <asp:Label ID="lbTotal_fee" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="font_content" align="right">
        ...
        <tr>
            ...
            <td class="font_content" align="left">
                <asp:Label ID="lbBuyer_email" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="font_content" align="right">
