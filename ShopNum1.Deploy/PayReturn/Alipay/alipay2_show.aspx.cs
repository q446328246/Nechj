...
{
    public partial class alipay2_show : Page, IRequiresSessionState
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (requestGet.Count > 0)
            {
                ...
                if (responseTxt == "true" && a == mysign)
                {
                    ...
                    //string text3 = HttpUtility.UrlDecode(base.Request.Form["subject"].ToString());
                    ...
                    if (base.Request.QueryString["trade_status"] == "TRADE_FINISHED" || base.Request.QueryString["trade_status"] == "TRADE_SUCCESS")
                    {
                        ...
                        //            int num1 = int.Parse(dataTable.Rows[0]["PaymentStatus"].ToString());
