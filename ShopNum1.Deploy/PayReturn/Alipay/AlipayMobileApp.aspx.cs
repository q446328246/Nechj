...
namespace ShopNum1.Deploy.PayReturn.Alipay
{
    public partial class AlipayMobileApp : System.Web.UI.Page
    {
        ...
        #endregion
        string key = @"";
        ...
        public static string CreateLinkStringUrlencode(Dictionary<string, string> dicArray, Encoding code)
        {
            ...
            {
                prestr.Append(temp.Key + "=" + HttpUtility.UrlDecode(temp.Value, code) + "&");
            }
        ...
        private bool GetSignVeryfy(SortedDictionary<string, string> inputPara, string sign)
        {
            ...
            //获取待签名字符串
            string preSignStr =  CreateLinkStringUrlencode(sPara, UTF8Encoding.UTF8);

            File.AppendAllText(base.Server.MapPath("~/log/111.txt"), "\r\n\t获取待签名字符串：" + preSignStr, Encoding.UTF8);
            //获得签名验证结果
            bool isSgin = false;
            if (sign != null && sign != "")
            {
                switch ("RSA2")
                {
                    case "RSA2":
                        ...
                        isSgin = AlipaySignature.RSACheckContent(preSignStr, sign, key, "utf-8", "RSA2", false);
                        File.AppendAllText(base.Server.MapPath("~/log/111.txt"), "\r\n\t获得签名验证结果：" + isSgin, Encoding.UTF8);
                        break;
                    default:
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
        ...
        
            {
                ...
                //bool assa = verify(ceshiString, ceshiSing, key, "utf-8");
                //bool saas = AlipaySignature.RSACheckContent(ceshiString, ceshiSing, key, "utf-8", "RSA2",false);
                File.AppendAllText(base.Server.MapPath("~/log/111.txt"), "获取的sign：" + Request.Form["sign"].ToString(), Encoding.UTF8);

                bool verifyResult = GetSignVeryfy(sPara, Request.Form["sign"]);
                ...
                if (verifyResult)//验证成功
                {
                    ...
                    string value = base.Request.Form["total_amount"];
        ...
        protected void IsMMS(string OrderNumber, string strCode, string memloginID, string string_0, string strProductName, string strBuyNum)
        {
            if (!(string_0.Trim() == ""))
            {
                ...
                if (editInfo != null && editInfo.Rows.Count > 0)
                {
                    ...
                    sMS.Send(string_0.Trim(), text2 + "【唐江巴巴】", out text3);
        ...
        public SortedDictionary<string, string> GetRequestPost()
        {
            ...
            coll = Request.Form;
            File.AppendAllText(base.Server.MapPath("~/log/111.txt"), "\r\n\t全返回值:" + Request.Form.ToString(), Encoding.UTF8);
