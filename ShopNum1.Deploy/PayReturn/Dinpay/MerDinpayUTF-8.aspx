<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerDinpayUTF-8.aspx.cs" Inherits="ShopNum1.Deploy.PayReturn.Dinpay.MerDinpayUTF_8" ResponseEncoding="utf-8" %>
...
<body >
    ...
    <body>
        <div id="cc">
            <table>
                <tr>
                    <td>
                        <img src="../../Main/Themes/Skin_Default/Images/20150413150752.jpg" />
                    </td>
                </tr>
            </table>
        </div>
    ...
    <!--main start-->
            ...
            <script type="text/javascript">
                ...
                function jumpurl() {
                    location = document.getElementById("dinpayForm").submit();
                }
