...
namespace ShopNum1.Deploy.KCFSservice
{
    /// <summary>
    /// KceAPI 的摘要说明
    /// </summary>
    ...
    public class KceAPI : System.Web.Services.WebService
    {
        //-----------------------------------------------------------------------------------------------------郭泽
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            else if (MyETH < Price)
                            {
                                message.Result = 0;
                                message.Code = "10023";
                                message.Message = "NEC不足!";
                                Context.Response.Write(KceApiHelper.GetJSON<GZMessage>(message));

                                Context.Response.End();
                            }
                            else if ((Price - Convert.ToDecimal(20)) < Convert.ToDecimal(20))
                            {
                                message.Result = 0;
                                message.Code = "10023";
                                message.Message = "扣除手续费后不够NEC最低提现额度!";
                                Context.Response.Write(KceApiHelper.GetJSON<GZMessage>(message));
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            else if ((Price - Convert.ToDecimal(0.01)) < Convert.ToDecimal(0.01))
                            {
                                message.Result = 0;
                                message.Code = "10023";
                                message.Message = "扣除手续费后不够ETH最低提现额度!";
                                Context.Response.Write(KceApiHelper.GetJSON<GZMessage>(message));
        ...
        public void CashWithdrawalTable(string Token, string MemLoginID)
        {
            ...
            if (ReturnValue == "1" && tValues[0].ToUpper() == MemLoginID.ToUpper())
            {
                ...
                else
                {
                    ...
                    message.Code = "没有更多提现记录";
                    message.Message = "没有更多提现记录";
                    message.Result = 0;
                    Context.Response.Write(KceApiHelper.GetJSON<GZMessage>(message));
                    Context.Response.End();
                }
        ...
        public void SelectFinancialProdct(int StartNumber, int EndNumber)
        {
            ...
            try
            {
                selectProducet = ((ShopNum1_Member_Action)LogicFactory.CreateShopNum1_Member_Action()).SelectFinancialProdct(StartNumber, EndNumber);
            }
            catch (Exception ex)
            {
        ...
        public void SelectFinancialProdctDetail(string Productid)
        {
            ...
            try
            {
                selectProducet = ((ShopNum1_Member_Action)LogicFactory.CreateShopNum1_Member_Action()).SelectFinancialProdctDetail(Productid);
            }
            catch (Exception ex)
            {
        ...
        public void GetVersionAn()
        {
            ...
            product.Address = "http://www.tj88.ren/necAPP.apk";
        ...
        public void MemberRegister(string Mobile, string MobileCode, string Name, string PassWord, string IIPassWord, string Referee)
        {
            ...
            try
            {
                ...
                if (PassWord == IIPassWord)
                {
                    message.Result = 0;
                    message.Code = "0o_x100007";
                    message.Message = "登陆密码和支付密码不能相等";
                }
                else if (IIPassWord.Length != 6)
                {
                    message.Result = 0;
                    message.Code = "0o_x100008";
                    message.Message = "交易密码必须为6位";
        ...
        public void LoginLosser(string MemLoginID, string PWD, string Encryption, string Code) //
        {
                ...
                if (selectMember.Rows.Count > 0)
                {
                    ...
                    else if (ErrorNum >= 5)
                    {
                        ...
                        else
                        {
                            ...
                            message.Message = "用户密码错误次数过多已经被禁用";
            ...
            {
                message.Result = 0;
                message.Code = "两次加密串对比不匹配";
                message.Message = "验证码错误，请重新输入验证码";
        ...
        public void SignInLosser(string MemLoginID, string token)
        {
            ...
            if (ReturnValue == "1" && tValues[0].ToUpper() == MemLoginID.ToUpper())
            {
                try
                {
                    ...
                    DateTime dtimeMY = Convert.ToDateTime("00:30:00");
                    if (dtime > dtimeMY)
                    {
        ...
        public void SignIn(string MemLoginID, string token)
        {
            ...
            if (ReturnValue == "1" && tValues[0].ToUpper() == MemLoginID.ToUpper())
            {
                try
                {
                    ...
                    int RandomNumber = ran.Next(1, 21);
                    decimal SignInBonus = Convert.ToDecimal(RandomNumber * 0.1);
                    ...
                    else
                    {
                        ...
                        if (mybonus > 0)
                        {
                            int AddSignIn = member_Action.Mjc_GetInformetionBonus(MemLoginID, SignInBonus.ToString(), "签到收益");
                            if (AddSignIn > 0)
                            {

                                message.Result = 1;
                                message.Code = SignInBonus.ToString();
                                message.Message = "您签到成功";
                            }
                            else
                            {
                                message.Result = 0;
        ...
        public void SignInDetial(string MemLoginID, string token)
        {
            ...
            if (ReturnValue == "1" && tValues[0].ToUpper() == MemLoginID.ToUpper())
            {
                try
                {
                    DataTable selectMember = member_Action.SignInSearchMemberMj(MemLoginID);
        ...
        public void QueryOtherAccounts(string MyMemloginID, string OtherMemloginID, string token)
        {
            ...
            if (ReturnValue == "1" && tValues[0].ToUpper() == MyMemloginID.ToUpper())
            {
                try
                {
                    DataTable TableMemBer = member_Action.SearchMemberGz(OtherMemloginID);
        ...
        /// <param name="type" >K宝 兑换为 K贝1/K宝转出 兑换CNY 2/CNY转出 兑换 K宝 3/二维码扫码转出 4/交易所转CNY 5/CNY转交易所6/商户转账7/  转账记录QLX只用12</param>
        /// <param name="token" token></param>
            ...
            if (ReturnValue == "1" && tValues[0].ToUpper() == MemLoginID.ToUpper())
            {
                try
                {
                    ...
                    if (SelectAddressByMemloginID > 0)
                    {
                        ...
                        message.Message = "修改昵称成功";
                    }
                    else
                    {
                        message.Result = 0;
                        message.Code = "0o_x20010";
                        message.Message = "修改昵称失败";
                    }
                }
                catch (Exception ex)
                {
        ...
        /// <param name="token"token></param>
        [WebMethod]
        public void OldPwdUpdateNewPwd(string MemLoginID, string OldPwd, string NewPwd, string token)
        {
            GZMessage message = new GZMessage();
            ShopNum1_Member_Action member_Action = (ShopNum1_Member_Action)ShopNum1.Factory.LogicFactory.CreateShopNum1_Member_Action();
            string TokenPuzzle = ShopNum1.Encryption.DESEncrypt.M_Decrypt(KceApiHelper.FormatParam(token));
        ...
        /// </summary>
        [WebMethod]
        public void OldIIPwdUpdateNewIIPwd(string MemLoginID, string OldPwd, string NewPwd, string token)
        {
            GZMessage message = new GZMessage();
            ShopNum1_Member_Action member_Action = (ShopNum1_Member_Action)ShopNum1.Factory.LogicFactory.CreateShopNum1_Member_Action();
            string TokenPuzzle = ShopNum1.Encryption.DESEncrypt.M_Decrypt(KceApiHelper.FormatParam(token));
        ...
        public void MyPurse(string MemLoginID, string token)
        {
            ...
            if (ReturnValue == "1" && tValues[0].ToUpper() == MemLoginID.ToUpper())
            {
                try
                {
                    ...
                    if (NewestEarnings.Rows.Count > 0 && NewestEarnings != null)
                    {
                        DataTable NCEBiLibili = member_Action.QLCNewestEarningsNCE(MemLoginID);//查最新收益
                        decimal BiLi = Convert.ToDecimal(NCEBiLibili.Rows[0]["NECBiLi"]);
                        Gz_LogicApi GetEthMedth = new Gz_LogicApi();
                        decimal ss;
                        try
                        {
                              ss = Convert.ToDecimal(GetEthMedth.SelectETHBili());
                        }
                        catch (Exception)
                        {
                        ...
                        decimal usdt_zhuan_eth;
                        try
                        {
                            usdt_zhuan_eth = Convert.ToDecimal(GetEthMedth.SelectUSDTBili());
                        }
                        catch (Exception)
                        {
                        ...
                        string UsableNEC = NewestEarnings.Rows[0]["Score_dv"].ToString();//可用NEC
        ...
        public void QueryReferee(string MemLoginID, int top, int number, string token)
        {
            ...
            if (ReturnValue == "1" && tValues[0].ToUpper() == MemLoginID.ToUpper())
            {
                try
                {
                    DataTable SelectAddressByMemloginID = member_Action.QueryReference1(MemLoginID, top, number);
                    //DataTable SelectAddressByMemloginIDCount = member_Action.GetmemebierCount(MemloginID, type, GatheringOrTransferAccountsType);
                    if (SelectAddressByMemloginID != null && SelectAddressByMemloginID.Rows.Count > 0)
                    {
            ...
            if (ReturnValue == "1" && tValues[0].ToUpper() == MemLoginID.ToUpper())
            {
                try
                {
                    ...
                    if (memshipChongFu.Rows.Count > 0)
                    {
                        message.Result = 0;
                        message.Code = "000002";
                        message.Message = "您已在申请列表中，请等待系统审批！";
                        Context.Response.Write(KceApiHelper.GetJSON<GZMessage>(message));
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (memshipChongFu.Rows.Count > 0)
                            {
                                message.Result = 0;
                                message.Code = "000002";
                                message.Message = "您已经绑定过了，请勿重复绑定！";
                                Context.Response.Write(KceApiHelper.GetJSON<GZMessage>(message));
                            }
                            else
                            {
        ...
        public void TiXianRecord(string MemLoginID, string type, string top, string number, string token)
        {
            ...
            if (ReturnValue == "1" && tValues[0].ToUpper() == MemLoginID.ToUpper())
            {
                try
                {
                    DataTable SelectAddressByMemloginID = member_Action.Select_NEC_TiXian(MemLoginID, type, top, number);
                    //DataTable SelectAddressByMemloginIDCount = member_Action.GetmemebierCount(MemloginID, type, GatheringOrTransferAccountsType);
                    if (SelectAddressByMemloginID != null && SelectAddressByMemloginID.Rows.Count > 0)
                    {
                    ...
                    try
                    {
                        ...
                        if (selectMember != null && selectMember.Rows.Count > 0)
                        {
                            ...
                            else
                            {
                                ...
                                message.Message = "该订单已完成交易或订单不存在。";
                            }
                        }
                        else
                        {
