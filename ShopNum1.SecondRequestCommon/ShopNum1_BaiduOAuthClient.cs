namespace ShopNum1.Second
{
    ...
    {
        private readonly string a1 = "https://openapi.baidu.com/oauth/2.0/authorize";
        private readonly string b1 = "https://openapi.baidu.com/oauth/2.0/token";

        private ShopNum1_BaiduOAuthMessage a(string A_0)
        {
            ...
            input = input.Replace(@"\", @"\\");
            return serializer.Deserialize<ShopNum1_BaiduOAuthMessage>(input);
        }
