...
namespace ShopNum1.ShopNewWebControl
{
    ...
    public class ProductListIsNewMore : BaseWebControl
    {
        ...
        private string skinFilename = "ProductListIsNewMore.ascx";
        ...
        public void ImageButtonGrid_Click(object sender, ImageClickEventArgs e)
        {
            ...
            method_1();
            ImageButtonList.ImageUrl = "../Images/tabulat.png";
        ...
        {
            Page.Response.Redirect(
                string.Concat(new object[] { string_1, "?category=", CookieCustomerCategory, "&sort=", soft, "&ordername=", ordername, "&pageid=", int_1 - 1 }));
        }
        ...
        protected void LinkButtonRenqi_Click(object sender, EventArgs e)
        {
            ...
            Page.Response.Redirect(string_1 + "?category="+CookieCustomerCategory+"&sort=" + soft + "&ordername=" + ordername);
        }
        ...
        {
            if (ordername.ToLower() == "modifytime")
            {
                soft = (Page.Request.QueryString["sort"] == null) ? "" : Page.Request.QueryString["sort"];
                if ((soft == "asc") || (soft == ""))
                {
        ...
        protected void method_1()
        {
            ...
            var bll = new PageListBll("ProductListNew", true)
            {
