...
namespace ShopNum1.WebControl
{
    ...
    public class SupplyDemandAllCategory : BaseWebControl
    {
        ...
        private string skinFilename = "SupplyDemandAllCategory.ascx";
        ...
        protected void method_0(object sender, RepeaterItemEventArgs e)
        {
            if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                DataRow[] source =
                    ShopNum1_SupplyDemandCheck_Action.SupplyDemandCategoryTable.Select("FatherID=" + field.Value);
        ...
        {
            DataRow[] source = ShopNum1_SupplyDemandCheck_Action.SupplyDemandCategoryTable.Select("FatherID=0");
            if ((source != null) && (source.Length > 0))
            {
