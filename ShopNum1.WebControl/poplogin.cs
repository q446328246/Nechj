...
namespace ShopNum1.WebControl
{
    ...
    public class poplogin : BaseWebControl
    {
        ...
        protected void ButtonLogin_Click(object sender, EventArgs e)
        {
            ...
            if (HiddenFieldLoginType.Value == "1")
            {
                memberPassWord = action.GetMemberPassWord(TextBoxMemLoginID.Text.Trim(),
                    Encryption.GetMd5Hash(TextBoxPwd.Text.Trim()));
            }
            if (HiddenFieldLoginType.Value == "2")
            {
                memberPassWord = action.LoginByEmail(TextBoxMemLoginID.Text.Trim(),
                    Encryption.GetMd5Hash(TextBoxPwd.Text.Trim()));
            }
            if ((memberPassWord != null) && (memberPassWord.Rows.Count > 0))
            {
                ...
                else if (memberPassWord.Rows[0]["IsMailActivation"].ToString() != "1")
                {
                    LabelLoginInfo.Text = "对不起，账号没有激活！";
                }
                else
                {
                    ...
                    action.UpdateLoginTime(TextBoxMemLoginID.Text.Trim(), Page.Request.UserHostAddress);
        ...
        protected void ButtonTwo_Click(object sender, EventArgs e)
        {
            ...
            if ((ShopSettings.GetValue("RegVerifyCode") == "1") &&
                ((Page.Session["code"] == null) ||
                 (TextBoxCode1.Text.ToUpper() != Page.Session["code"].ToString().ToUpper())))
            {
            ...
            else
            {
                ...
                if (action.Add(member) == 1)
                {
                    ...
                    if (str2 == "1")
                    {
                        if ((TextBoxEmail.Text == "") && (TextBoxMemLoginID.Text != ""))
                        {
                        ...
                        try
                        {
                            RegIsActivationEmail email2;
                            str21 = Guid.NewGuid().ToString();
                            email2 = new RegIsActivationEmail
                            {
                                Email = TextBoxEmail.Text.Trim(),
                                Name = TextBoxMemLoginID.Text.Trim(),
                                link =
                                    GetPageName.RetDomainUrl("MemberRegisterToMail") + "?code=" + str21 +
                            ...
                            SendMailForRegister(TextBoxMemLoginID.Text.Trim(), TextBoxEmail.Text.Trim(), str21, "", str7,
                                str9,
                                str8);
                        }
                    ...
                    if ((str == "1") && (str2 == "0"))
                    {
                        ...
                        new SendEmail().Emails(TextBoxEmail.Text.Trim(), TextBoxMemLoginID.Text.Trim(), str7, str9, str8);
                    }
                    AddScroll();
                    if (str2 == "0")
                    {
