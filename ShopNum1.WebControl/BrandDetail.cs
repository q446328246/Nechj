...
namespace ShopNum1.WebControl
{
    ...
    public class BrandDetail : BaseWebControl
    {
        ...
        private readonly string string_1 = GetPageName.RetDomainUrl("BrandDetail");
        ...
        private HtmlGenericControl hideProduct;
        private int int_0;
        private HtmlGenericControl pageDiv;

        private string skinFilename = "BrandDetail.ascx";
        ...
        {
            hideProduct = (HtmlGenericControl) skin.FindControl("hideProduct");
            ...
            style = (Common.Common.ReqStr("style") == null) ? "list" : Common.Common.ReqStr("style");
            string_5 = (Common.Common.ReqStr("ordername") == "") ? "orderid" : Common.Common.ReqStr("ordername");
            string_4 = (Common.Common.ReqStr("sort") == "desc") ? "desc" : "asc";
            ...
            Func<string, bool> func = method_3;
            if (Pvalue != "-1")
            {
                func(Pvalue);
            }
            ...
            if (Common.Common.ReqStr("guid") != "")
            {
                HiddenFieldGuid.Value = Common.Common.ReqStr("guid");
            }
            else
            {
            ...
            BindData();
            method_2(Common.Common.ReqStr("ordername"), Common.Common.ReqStr("sort"));
        ...
        {
            DataTable editInfo =
                ((ShopNum1_Brand_Action) LogicFactory.CreateShopNum1_Brand_Action()).GetEditInfo("'" + brandguid + "'");
            ...
            {
                hideProduct.Visible = false;
            }
            RepeaterData.DataSource = editInfo.DefaultView;
        ...
        protected void method_1()
        {
            ...
            pageDiv.InnerHtml =
                new PageListBll("BrandDetail", true)
                {
        ...
        protected void method_2(string string_10, string string_11)
        {
            if (style == "list")
            {
