...
{
    public class Search_productlist9 : BaseWebControl
    {
        ...
        private readonly string string_1 = GetPageName.RetDomainUrl("Search_productlist9");
        ...
        private string skinFilename = "Search_productlist9.ascx";
