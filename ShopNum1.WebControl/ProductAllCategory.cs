...
namespace ShopNum1.WebControl
{
    ...
    public class ProductAllCategory : BaseWebControl
    {
        ...
        private string skinFilename = "ProductAllCategory.ascx";
        ...
        protected void method_0(object sender, RepeaterItemEventArgs e)
        {
            if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                DataRow[] source = ShopNum1_ProductCategory_Action.ProductCategoryTable.Select("FatherID=" + field.Value);
        ...
        {
            DataRow[] source = ShopNum1_ProductCategory_Action.ProductCategoryTable.Select("FatherID=0");
            if ((source != null) && (source.Length > 0))
            {
