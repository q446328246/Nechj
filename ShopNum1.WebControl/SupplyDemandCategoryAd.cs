...
namespace ShopNum1.WebControl
{
    ...
    public class SupplyDemandCategoryAd : BaseWebControl
    {
        ...
        private string skinFilename = "SupplyDemandCategoryAd.ascx";
        ...
        protected override void InitializeSkin(Control skin)
        {
            ...
            DataTable table = action.SearchAdInfo(AdID, categorycode, "3");
            ...
            {
                DataTable table2 = action.SearchAdInfo(AdID, "3");
