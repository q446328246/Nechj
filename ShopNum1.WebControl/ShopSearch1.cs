...
namespace ShopNum1.WebControl
{
    public class ShopSearch1 : BaseWebControl
    {
        ...
        private bool bool_0;
        private string skinFilename = "ShopSearch1.ascx";
        ...
        protected void BindData()
        {
            ...
            if (!(!(Common.Common.ReqStr("code") != "") || bool_0))
            {
                str2 = Common.Common.ReqStr("code");
            }
            else
            {
            ...
            if (!(!(Common.Common.ReqStr("search") != "") || bool_0))
            {
                str3 = Page.Server.UrlDecode(Common.Common.ReqStr("search"));
            }
            else
            {
