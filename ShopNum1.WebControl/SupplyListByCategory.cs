...
namespace ShopNum1.WebControl
{
    ...
    public class SupplyListByCategory : BaseWebControl
    {
        ...
        private string skinFilename = "SupplyListByCategory.ascx";
        ...
        protected override void InitializeSkin(Control skin)
        {
            ...
            {
                Href.HRef = GetPageName.RetUrl("SupplyDemandListSearch", CategoryCode, "code");
            }
            else
            {
                Href.HRef = GetPageName.RetUrl("SupplyDemandListSearch");
            }
            BindData();
        }
    }
