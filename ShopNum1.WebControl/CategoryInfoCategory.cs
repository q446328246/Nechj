...
namespace ShopNum1.WebControl
{
    ...
    public class CategoryInfoCategory : BaseWebControl
    {
        ...
        private string skinFilename = "CategoryInfoCategory.ascx";
        ...
        protected void method_0(object sender, RepeaterItemEventArgs e)
        {
            if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                DataRow[] source = ShopNum1_CategoryChecked_Action.CategoryTable.Select("FatherID=" + field.Value);
        ...
        {
            DataRow[] source = ShopNum1_CategoryChecked_Action.CategoryTable.Select("FatherID=0");
            if ((source != null) && (source.Length > 0))
            {
