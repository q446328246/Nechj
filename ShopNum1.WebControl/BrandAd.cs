...
namespace ShopNum1.WebControl
{
    ...
    public class BrandAd : BaseWebControl
    {
        ...
        private string skinFilename = "BrandAd.ascx";
        ...
        {
            string categorycode = (Common.Common.ReqStr("code") == null) ? "-1" : Common.Common.ReqStr("code");
            ...
            DataTable table = action.SearchAdInfo(AdID, categorycode, "6");
            ...
            {
                DataTable table2 = action.SearchAdInfo(AdID, "6");
