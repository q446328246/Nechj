...
namespace ShopNum1.WebControl
{
    ...
    public class BrandAllCategory : BaseWebControl
    {
        ...
        private int int_1;
        private int int_2 = 0;
        private string skinFilename = "BrandAllCategory.ascx";
        ...
        {
            get { return ShowCountThree; }
            set { ShowCountThree = value; }
        }
        ...
        protected void method_0(object sender, RepeaterItemEventArgs e)
        {
            if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                {
                    repeater.DataSource = (int_2 == 0) ? category : Top(category, int_2);
                    repeater.DataBind();
                    var literal = (Literal) repeater.Items[repeater.Items.Count - 1].FindControl("LiteralLine");
        ...
        protected void method_1()
        {
            ...
            RepeaterData.DataSource = (int_0 == 0) ? category : Top(category, int_0);
        ...
        protected void RepeaterData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                if (category.Rows.Count > 0)
                {
                    repeater.DataSource = (int_1 == 0) ? category : Top(category, int_1);
                    repeater.DataBind();
                }
            }
        }
