...
namespace ShopNum1.WebControl
{
    ...
    public class SupplyDemandList : BaseWebControl
    {
        ...
        private string skinFilename = "SupplyDemandList.ascx";
        ...
        {
            DataTable table =
                ((ShopNum1_SupplyDemandCheck_Action) LogicFactory.CreateShopNum1_SupplyDemandCheck_Action()).Search(0, 0,
                    ShowCountOne);
        ...
        protected void RepeaterData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                DataTable table =
                    ((ShopNum1_SupplyDemandCheck_Action) LogicFactory.CreateShopNum1_SupplyDemandCheck_Action()).Search(
