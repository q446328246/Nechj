...
namespace ShopNum1.ShopAdminWebControl
{
    ...
    public class S_SellProduct : BaseShopWebControl
    {
        ...
        private string skinFilename = "S_SellProduct.ascx";
        ...
        protected void BindData()
        {
            ...
            {
                action.DeleteShopNum1_Shop_ProductPricet(Common.Common.ReqStr("del"), Common.Common.ReqStr("myid"));
            }
        }
        ...
        protected void method_2()
        {
            ...
            DataTable table = action.GetProductList_two(PageSize.ToString(), strCurrentPage, method_1(), "0");
            ...
            pageDiv.InnerHtml =
                new PageListBll("shop/ShopAdmin/S_SellProduct.aspx", true).GetPageListNew(pl);


            dt_ShowProduct = action.GetProductList(PageSize.ToString(), strCurrentPage, method_1(), "1");
            
            if (dt_ShowProduct.Rows.Count == 0)
            {
                dt_ShowProduct = null;
            }
