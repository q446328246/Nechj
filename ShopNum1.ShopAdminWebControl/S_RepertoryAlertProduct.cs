...
namespace ShopNum1.ShopAdminWebControl
{
    ...
    public class S_RepertoryAlertProduct : BaseShopWebControl
    {
        ...
        private string skinFilename = "S_RepertoryAlertProduct.ascx";
        ...
        private string method_1()
        {
            ...
            builder.Append(" and memloginid='" + base.MemLoginID +
                           "' and issell=1 and isdeleted=0 and isaudit=1 and issaled=1 and RepertoryCount<=RepertoryAlertCount ");
            if (string_5 != "")
            {
        ...
        protected void method_2()
        {
            ...
            pageDiv.InnerHtml =
                new PageListBll("shop/ShopAdmin/S_RepertoryAlertProduct.aspx", true).GetPageListNew(pl);
