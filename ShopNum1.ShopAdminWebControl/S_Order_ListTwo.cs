...
{
    [ParseChildren(true)]
    public class S_Order_ListTwo : BaseShopWebControl
    {
        ...
        private string skinFilename = "S_Order_ListTwo.ascx";

        public S_Order_ListTwo()
        {
        ...
        protected void method_0()
        {
            if (Common.Common.ReqStr("sign") == "del" && Common.Common.ReqStr("del") != "")
            {
                ...
                shopNum1_OrderInfo_Action.DeleteOrderInfoByOrdernumtwo(Common.Common.ReqStr("del"), 0, MemLoginID);
            }
        }
        ...
        protected void method_2()
        {
            ...
            DataTable dataTable = shopNum1_OrderInfo_Action.SelectOrderListGZTwo(PageSize.ToString(), num.ToString(),
                method_1(), "3",
                HttpUtility.HtmlDecode(
                    Common.Common.ReqStr("pn")));
            int recordCount = Convert.ToInt32(dataTable.Rows[0][0]);
            var pageListBll = new PageListBll("shop/ShopAdmin/S_Order_ListTwo.aspx", true);
            ...
            dt_OrderList = shopNum1_OrderInfo_Action.SelectOrderListGZTwo(PageSize.ToString(), num.ToString(), method_1(),
                "2",
        ...
        public static DataTable dt_GetOrderProduct(string OrderGuId)
        {
            ...
            if (cookie2 != null)
            {
                return shopNum1_OrderProduct_Action.Pro_Shop_GetOrderProductByGuIdorAllAndMemloginIdTwo(cookie2.Values["MemLoginID"], OrderGuId,
              HttpUtility.HtmlDecode(
                  Common.Common.ReqStr("pn")));
            }
            else
            {
                return shopNum1_OrderProduct_Action.Pro_Shop_GetOrderProductByGuIdorAllAndMemloginIdTwo("", OrderGuId,
              HttpUtility.HtmlDecode(
                  Common.Common.ReqStr("pn")));
            }
