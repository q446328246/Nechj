...
namespace ShopNum1.ShopAdminWebControl
{
    ...
    public class S_UnAuditProduct : BaseShopWebControl
    {
        ...
        private string skinFilename = "S_UnAuditProduct.ascx";
        ...
        private string method_1()
        {
            ...
            builder.Append(" and memloginid='" + base.MemLoginID + "' and  isaudit in(0,2) ");
            if (string_5 != "")
            {
        ...
        protected void method_2()
        {
            ...
            pageDiv.InnerHtml =
                new PageListBll("shop/ShopAdmin/S_UnAuditProduct.aspx", true).GetPageListNew(pl);
