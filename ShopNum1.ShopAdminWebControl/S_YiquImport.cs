...
namespace ShopNum1.ShopAdminWebControl
{
    ...
    public class S_YiquImport : BaseShopWebControl, IPostBackEventHandler
    {
        ...
        private string skinFilename = "S_YiquImport.ascx";
        ...
        protected bool OpImport()
        {
            ...
            if (ImportCSV(strPath))
            {
                ...
                string str2 = DateTime.Parse(memLoginInfo.Rows[0]["OpenTime"].ToString()).ToString("MM-dd");
        ...
        public static DataTable read_csv(string filepath)
        {
            ...
            for (num = 0; num < list.Count; num++)
            {
                ...
                {
                    if ((list[num][0] == null) || (list[num][0] == string.Empty))
                    {
                        goto lblMsg293;
                    }
