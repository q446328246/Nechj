...
namespace ShopNum1.ShopAdminWebControl
{
    ...
    public class W_ShopReplyTextList : BaseShopWebControl
    {
        ...
        private string skinFilename = "W_ShopReplyTextList.ascx";
        ...
        protected void BindReplyText()
        {
            IShopNum1_Weixin_ReplyRule_Active active = new ShopNum1_Weixin_ReplyRule_Active();
            DataSet set = active.SelectReplyRule(base.MemLoginID, 0);
            if (set.Tables.Count != 0)
            {
                ...
                foreach (DataRow row in table.Rows)
                {
                    ...
                    string str = (rowArray2.Length != 0) ? rowArray2[0]["RepMsgContent"].ToString() : string.Empty;
                    if (str.Length > 20)
                    {
