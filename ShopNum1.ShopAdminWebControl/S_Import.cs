...
namespace ShopNum1.ShopAdminWebControl
{
    ...
    public class S_Import : BaseShopWebControl, IPostBackEventHandler
    {
        ...
        private string skinFilename = "S_Import.ascx";
                ...
                if (ImportCSV(strPath))
                {
                    ...
                    while (true)
                    {
                        ...
                        try
                        {
                            ...
                            if (dt.Rows[num3]["省"].ToString() != "")
                            {
                                product.AddressCode = "00";
                                product.AddressValue = dt.Rows[num3]["省"].ToString();
                                if (dt.Rows[num3]["城市"].ToString() != "")
                                {
                                    product.AddressCode = "00,00";
                                    product.AddressValue = dt.Rows[num3]["省"] + "," +
                                                           dt.Rows[num3]["城市"];
                                }
                            }
                            product.Name = dt.Rows[num3]["宝贝名称"].ToString();
                            ...
                            priceCTC.marketPrice = Convert.ToDecimal(dt.Rows[num3]["宝贝价格"].ToString().Trim());
                            priceCTC.Shop_category_id = 9;
                            priceCTC.shopPrice = Convert.ToDecimal(dt.Rows[num3]["宝贝价格"].ToString().Trim());
                            ...
                            priceCTC.Score_Score_dv = 0;
                            priceCTC.scroce_pv_cv = 0;
                            priceCTC.Score_Score_Pv_b = 0;
                            ...
                            product.Detail =
                                Regex.Replace(HttpUtility.HtmlDecode(dt.Rows[num3]["宝贝描述"].ToString()),
                                    "=\"\"[\\w](.*?)\"\"", matchEvaluator_0);
                            ...
                            if (dt.Rows[num3]["新图片"].ToString() != string.Empty)
                            {
                                try
                                {
                                    ...
                                    string str6 = str4 + new Random().Next(0x3e8);
                                    str7 = ShopImgUpload + str6 + ".jpg";
                                    if (!Directory.Exists(Page.Server.MapPath(ShopImgUpload)))
                                    {
                                        Directory.CreateDirectory(Page.Server.MapPath(ShopImgUpload));
                                    }
                                    info.CopyTo(Page.Server.MapPath(str7));
                                    string str8 = str7 + "_25x25.jpg";
                                    string str9 = str7 + "_60x60.jpg";
                                    str10 = str7 + "_100x100.jpg";
                                    string str11 = str7 + "_160x160.jpg";
                                    path = str7 + "_300x300.jpg";
                                    ImageOperator.CreateThumbnailAuto(HttpContext.Current.Server.MapPath(str7),
                                        HttpContext.Current.Server.MapPath(str8), 0x19,
                                        0x19);
                                    ImageOperator.CreateThumbnailAuto(HttpContext.Current.Server.MapPath(str7),
                                        HttpContext.Current.Server.MapPath(str9), 60, 60);
                                    ImageOperator.CreateThumbnailAuto(HttpContext.Current.Server.MapPath(str7),
                                        HttpContext.Current.Server.MapPath(str10), 100,
                                        100);
                                    ImageOperator.CreateThumbnailAuto(HttpContext.Current.Server.MapPath(str7),
                                        HttpContext.Current.Server.MapPath(str11), 160,
                                        160);
                                    ImageOperator.CreateThumbnailAuto(HttpContext.Current.Server.MapPath(str7),
                                        HttpContext.Current.Server.MapPath(path), 300, 300);
                                    product.OriginalImage = str7;
                                    AddImageSizeToXML(str7);
                                    AddImageToDataBase(str7);
                                }
                            ...
                            product.AddressValue = dt.Rows[num3]["省"].ToString();
                            product.MultiImages = str7;
                            product.OriginalImage = str7;
                            product.ThumbImage = str7;
                            product.SmallImage = str7;
