        ...
        public string EmailTitle
        {
            ...
            set
            {
                if (string_2 != value)
                {
                    SendPropertyChanging();
                    string_2 = value;
                    SendPropertyChanged("EmailTitle");
                }
            }
        }
        ...
        public string SendObject
        {
            ...
            set
            {
                if (string_0 != value)
                {
                    SendPropertyChanging();
                    string_0 = value;
                    SendPropertyChanged("SendObject");
                }
            }
        }

        //[Column(Storage = "_SendObjectEmail", DbType = "NText NOT NULL", CanBeNull = false,
        ...
        public string SendObjectEmail
        {
            ...
            set
            {
                if (string_1 != value)
                {
                    SendPropertyChanging();
                    string_1 = value;
                    SendPropertyChanged("SendObjectEmail");
                }
            }
        }
        ...
        public DateTime? TimeSendTime
        {
            ...
            set
            {
                if (dateTime_1 != value)
                {
                    SendPropertyChanging();
                    dateTime_1 = value;
                    SendPropertyChanged("TimeSendTime");
                }
            }
        }
