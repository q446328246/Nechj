...
namespace ShopNum1MultiEntity
{
    ...
    public class ShopNum1_M_Member4 : INotifyPropertyChanging, INotifyPropertyChanged
    {
       ...
       new PropertyChangingEventArgs(string.Empty);
        ...
        private string yesterdayAllBonus;
        public string YesterdayAllBonus
        {
            get { return yesterdayAllBonus; }
            set { yesterdayAllBonus = value; }
        }
        ...
        public static ShopNum1_M_Member4 FromDataRow(DataRow row,string device_no)
        {
            ShopNum1_M_Member4 M_Member = new ShopNum1_M_Member4();
            ...
            M_Member.YesterdayAllBonus= row["YesterdayAllBonus"].ToString();
